    ...
    public class GhiChiSoDao
    {
            ...
            try
            {
                var insertNewQuery = from kh in _db.KHACHHANGs
                                     ...
                                     select new
                                     {
                                         ...
                                         kh.SOHO, kh.SONK, kh.ISDINHMUC, kh.TTSD, kh.KHONGTINH117, kh.KYHOTRO,
                ...
                foreach (var dp in dpList)
                {
                    ...
                    var insertOldQuery = from kh in _db.KHACHHANGs
                                         ...
                                         select new
                                         {
                                             ...
                                             CHISOCUOI = kh.TTSD.Equals("CUP") ? tt.CHISOCUOI : 0,
                    ...
                    var tt = new TIEUTHU
                                 {
                                     ...
                                     SOHO = kh.SOHO, SONK = kh.SONK, ISDINHMUC = kh.ISDINHMUC, DMNK = GetDMNK(), KHONGTINH117 = kh.KHONGTINH117,
                                     ...
                                     PHIMUC2 = 0, TNUOCMUC3 = 0, THUEMUC3 = 0,   PHIMUC3 = 0,THBT = "BT",
        ...
        public Message KhoiTaoGhiChiSoBoSung(DateTime date, string makv)
        {
            ...
            try
            {
                ...
                var joinQuery = from kh in _db.KHACHHANGs
                                join tt in _db.TIEUTHUs on kh.IDKH equals tt.IDKH
                                where (tt.TTSD != "CUP") && (tt.INHD == true) && tt.THANG == date.Month && (tt.MAKV == makv || makv == "%")
                                select tt;
