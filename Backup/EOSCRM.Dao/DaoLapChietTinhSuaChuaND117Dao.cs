...
{
    public  class DaoLapChietTinhSuaChuaNd117Dao
    {
        private readonly EOSCRMDataContext _db;
        public static readonly string Connectionstring = ConfigurationManager.AppSettings[Constants.SETTINGS_CONNECTION];
        public DaoLapChietTinhSuaChuaNd117Dao()
        {
            _db = new EOSCRMDataContext(Connectionstring);
        }
        
        public DAOLAPSUACHUA_ND117  Get(int maDon)
        {
            return _db.DAOLAPSUACHUA_ND117s.Where(p => p.MA.Equals(maDon)).SingleOrDefault();
        }

        public List<DAOLAPSUACHUA_ND117> GetList(string maSC)
        {
            return _db.DAOLAPSUACHUA_ND117s.Where(p => p.MADON.Equals(maSC)).ToList();
        }


        public Message Insert(DAOLAPSUACHUA_ND117 objUi)
        {
            Message msg;
            try
            {
                ...
                _db.DAOLAPSUACHUA_ND117s.InsertOnSubmit(objUi);
                _db.SubmitChanges();
        ...
        public Message Update(DAOLAPSUACHUA_ND117 objUi)
        {
            Message msg;
            try
            {
        ...
        public Message Delete(DAOLAPSUACHUA_ND117 objUi)
        {
            Message msg;
            ...
            try
            {
                ...
                // Set delete info
                _db.DAOLAPSUACHUA_ND117s.DeleteOnSubmit(objDb);
                // Submit changes to db
                _db.SubmitChanges();
        ...
        /// <returns></returns>
        public Message DeleteList(List<DAOLAPSUACHUA_ND117> objList, PageAction action)
        {
            Message msg;
