...
namespace EOSCRM.Web.UserControls
{
    public partial class KhachHangFilterPanel : UserControl
    {
        ...
        public string GHI2THANG1LAN
        {
            get { return ghi2thang1lan; }
            set { ghi2thang1lan = value; }
        }
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            ddlGHI2THANG1LAN.Items.Clear();
            ddlGHI2THANG1LAN.Items.Add(new ListItem("Tất cả", "NULL"));
            ddlGHI2THANG1LAN.Items.Add(new ListItem("Không", "0"));
            ddlGHI2THANG1LAN.Items.Add(new ListItem("Có", "1"));
        ...
        protected void btnFilter_Click(object sender, EventArgs e)
        {
            ...
            if (ddlGHI2THANG1LAN.SelectedIndex >= 0)
                hash.Add(Constants.PARAM_GHI2THANG1LAN, EncryptUtil.Encrypt(ddlGHI2THANG1LAN.SelectedValue.Trim()));
