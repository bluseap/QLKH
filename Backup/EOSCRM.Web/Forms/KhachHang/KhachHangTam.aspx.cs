        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (UpdateMode == Mode.Create)
                {
                    ...
                    msg = khDao.Insert(kh, CommonFunc.GetComputerName(), CommonFunc.GetIpAdddressComputerName(), LoginInfo.MANV);
                ...
                else
                {
                    ...
                    msg = khDao.Update(kh, DateTime.Now.Month, DateTime.Now.Year, CommonFunc.GetComputerName(), CommonFunc.GetIpAdddressComputerName(), LoginInfo.MANV);
