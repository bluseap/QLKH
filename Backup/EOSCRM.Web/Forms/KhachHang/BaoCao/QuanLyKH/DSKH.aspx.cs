...
// ReSharper restore EmptyGeneralCatchClause
            ...
            var dt =
                new ReportClass().Dskh(txtMaDp.Text.Trim(), txtDuongPhu.Text.Trim(), cboMucDichSuDung.Text.Trim(),
                                       cboTrangThai.Text.Trim(), cboKhuVuc.Text.Trim(),chkLocHaiGia.Checked).Tables[0];
            ...
            txtTIEUDE1.Text = "DANH SÁCH KHÁCH HÀNG";
