...
{
    public partial class DS_ChuaLapCT : Authentication
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    var dt = (DataTable)Session[SessionKey.TK_BAOCAO_CHUACHIETTINH];
                    Report(dt);
                }
            }
            catch (Exception ex)
        ...
        {
            Page.Title = Resources.Message.TITLE_KH_BAOCAO_DLM_CHUACHIETTINH;

            var header = (Header)Master.FindControl("header");
            if (header != null)
            {
                header.ModuleName = Resources.Message.MODULE_KHACHHANG;
                header.TitlePage = Resources.Message.PAGE_KH_BAOCAO_DLM_CHUACHIETTINH;
            }
        }
        ...
        protected void btnBaoCao_Click(object sender, EventArgs e)
        {
            ...
            var ds = new ReportClass().RpdsChoLapCt(TuNgay, DenNgay, cboKhuVuc.Text, "");
        ...
        private void Report(DataTable dt)
        {
            ...
            if (txtTitle != null)
                txtTitle.Text = "DANH SÁCH CHƯA LẬP CHIẾT TÍNH";
            ...
            Session[SessionKey.TK_BAOCAO_CHUACHIETTINH] = dt;
