...
{
    public partial class DS_ChoLapCT : Authentication
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    var dt = (DataTable)Session[SessionKey.TK_BAOCAO_CHOCHIETTINH];
                    Report(dt);
                }
            }
            catch (Exception ex)
        ...
        {
            Page.Title = Resources.Message.TITLE_KH_BAOCAO_DLM_CHOCHIETTINH;

            var header = (Header)Master.FindControl("header");
            if (header != null)
            {
                header.ModuleName = Resources.Message.MODULE_KHACHHANG;
                header.TitlePage = Resources.Message.TITLE_KH_BAOCAO_DLM_CHOCHIETTINH;
            }
        }
        ...
        protected void btnBaoCao_Click(object sender, EventArgs e)
        {
            ...
            var ds = new ReportClass().RpdsChoLapCt(TuNgay, DenNgay, cboKhuVuc.Text, "CT_P");
        ...
        private void Report(DataTable dt)
        {
            ...
            if (txtTitle != null)
                txtTitle.Text = "DANH SÁCH CHỜ DUYỆT CHIẾT TÍNH";
            ...
            Session[SessionKey.TK_BAOCAO_CHOCHIETTINH] = dt;
