...
{
    public partial class DS_DaLapCT : Authentication
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    var dt = (DataTable)Session[SessionKey.TK_BAOCAO_DACHIETTINH];
                    Report(dt);
                }
            }
            catch (Exception ex)
        ...
        {
            Page.Title = Resources.Message.TITLE_KH_BAOCAO_DLM_DACHIETTINH;

            var header = (Header)Master.FindControl("header");
            if (header != null)
            {
                header.ModuleName = Resources.Message.MODULE_KHACHHANG;
                header.TitlePage = Resources.Message.PAGE_KH_BAOCAO_DLM_DACHIETTINH;
            }
        }
        ...
        private void Report(DataTable dt)
        {
            ...
            if (txtTitle != null)
                txtTitle.Text = "DANH SÁCH LẬP CHIẾT TÍNH";
            ...
            Session[SessionKey.TK_BAOCAO_DACHIETTINH] = dt;
