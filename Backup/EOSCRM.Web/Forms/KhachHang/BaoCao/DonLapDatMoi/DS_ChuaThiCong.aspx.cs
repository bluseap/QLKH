...
{
    public partial class DS_ChuaThiCong : Authentication
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    var dt = (DataTable)Session[SessionKey.TK_BAOCAO_CHUATHICONG];
                    Report(dt);
                }
            }
            catch (Exception ex)
        ...
        {
            Page.Title = Resources.Message.TITLE_KH_BAOCAO_DLM_CHUATHICONG;

            var header = (Header)Master.FindControl("header");
            if (header != null)
            {
                header.ModuleName = Resources.Message.MODULE_KHACHHANG;
                header.TitlePage = Resources.Message.PAGE_KH_BAOCAO_DLM_CHUATHICONG;
            }
        }
        ...
        protected void btnBaoCao_Click(object sender, EventArgs e)
        {
            ...
            var ds = new ReportClass().RpdsThiCong(TuNgay, DenNgay, cboKhuVuc.Text, "");
        ...
        private void Report(DataTable dt)
        {
            ...
            if (txtTitle != null)
                txtTitle.Text = "DANH SÁCH CHƯA THI CÔNG";
            ...
            Session[SessionKey.TK_BAOCAO_CHUATHICONG] = dt;
