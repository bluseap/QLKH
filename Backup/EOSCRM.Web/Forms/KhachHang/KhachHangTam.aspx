<%@ Page Title="" Language="C#" MasterPageFile="~/Shared/EOS.Master" AutoEventWireup="true" CodeBehind="KhachHangTam.aspx.cs" Inherits="EOSCRM.Web.Forms.KhachHang.KhachHangTam" %>
                                ...
                                <table class="crmtable">
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="crmcell">
                                                <div class="left">
                                                    <asp:TextBox ID="txtKeywordHD" onchange="return CheckFormFilterHD();" runat="server" Width="250px" MaxLength="200" />
                                                </div>
                                                <div class="left">
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Địa chỉ">
                                                <ItemTemplate>
                                                    ...
                                                    <%# Eval("PHUONG") != null ? Eval("PHUONG.TENPHUONG") + ", " : "" %>
                                                    <%# Eval("KHUVUC.TENKV") %>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="crmcell">
                                ...
                                <div class="left">
                                    <asp:Label ID="lblSONO" runat="server" Visible="false" />
                                </div>                                                               
                                <div class="left">
                        ...
                        <tr>
                            ...
                            <td class="crmcell">                                
                                <div class="left">
                                    <asp:DropDownList ID="ddlKICHCODH" Width="48px" runat="server" TabIndex="10" 
                                        >
                        ...
                        <tr>
                            ...
                            <td class="crmcell">
                                <div class="left">
                                    ...
                                    OnSelectedIndexChanged="ddlMDSD_SelectedIndexChanged" runat="server" Width="170px" TabIndex="12" />
                                </div>
                                <div class="left">
                                    <asp:Label ID="lblGIA" runat="server" Font-Bold="True" ></asp:Label>
                                </div>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td class="crmcell">
                                <div class="left">
                                    <asp:TextBox ID="txtDIACHILD" runat="server" MaxLength="150" Width="100px" TabIndex="77" />
                                </div>
                            </td>
                            <td class="crmcell right">
                                Ngày lặp đặt
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderStyle-Width="10%" HeaderText="Mã khách hàng">
                            ...
                            <asp:LinkButton ID="linkMa" runat="server" 
                                ...
                                Text='<%# HttpUtility.HtmlEncode(Eval("MADP") + Eval("DUONGPHU").ToString()+ Eval("MADB")) %>'></asp:LinkButton>
                            </ItemTemplate>
