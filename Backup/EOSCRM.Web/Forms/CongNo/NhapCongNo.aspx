<%@ Page Language="C#" MasterPageFile="~/Shared/EOS.master" AutoEventWireup="True"
    Inherits="EOSCRM.Web.Forms.CongNo.NhapCongNo" CodeBehind="NhapCongNo.aspx.cs" %>
...
<asp:Content ID="content" ContentPlaceHolderID="ContentPlaceHolderMain" runat="server">
        ...
        <table class="crmtable">
            <tbody>
                <tr>
                    ...
                    <td class="crmcell">
                        <div class="left">
                            <asp:TextBox ID="txtMAVACH" runat="server" CssClass="width-100" MaxLength="8" TabIndex="1"
                ...
                <tr>
                    ...
                    <td class="crmcell">
                        ...
                        <div class="left width-150 pleft-50" style="width: 150px;">
                            <div class="right">Kỳ thu (dùng để lọc)</div>
                        </div>
                        <div class="left">
                ...
                <tr>
                    ...
                    <td class="crmcell">
                        ...
                        <div class="left">
                            <asp:Button ID="btnInPhieu" runat="server" CssClass="report" OnClick="btnInPhieu_Click"
    ...
    <br />
    <div class="crmcontainer" id="divThongKe" runat="server">
        <table class="crmtable">
            <tbody>
                <tr>
    ...
    <asp:UpdatePanel ID="upnlGrid" UpdateMode="Conditional" runat="server">
        <ContentTemplate>
            ...
            <div class="crmcontainer" id="divCongNoList" runat="server" visible="false">
                <eoscrm:Grid ID="gvList" runat="server" UseCustomPager="true" PageSize="20" OnPageIndexChanging="gvList_PageIndexChanging"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderStyle-Width="6%" HeaderText="NV nhập">
                            <ItemTemplate>
                                <%# (Eval("NHANVIEN1") != null) ?
