<%@ Page Language="C#" MasterPageFile="~/Shared/EOS.master" AutoEventWireup="True"
    Inherits="EOSCRM.Web.Forms.SuaChua.CapNhatSauSuaChua" CodeBehind="CapNhatSauSuaChua.aspx.cs" %>
                ...
                <table class="crmtable">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="crmcell">    
                                <div class="left">
                                    <asp:DropDownList ID="cboMAXL" runat="server" />
                                </div>
                            </td>
                        ...
                        <tr>
                            ...
                            <td class="crmcell">    
                                <div class="left">
                                    <asp:TextBox ID="txtCHINIEM" runat="server" MaxLength="50" Width="100px" Text="Niêm đủ ba chì" />
                                </div>
                            </td>
                        ...
                        <tr>
                            ...
                            <td class="crmcell">    
                                <div class="left">
                                    <asp:CheckBox ID="chkIsLapChietTinh" runat="server" />
                                </div>
                            </td>
                        </tr>
                        <tr>
                ...
                <eoscrm:Grid ID="gvList" runat="server" UseCustomPager="true" OnRowDataBound="gvList_RowDataBound" 
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Thông tin">
                            <ItemTemplate>
                                <%# 
                                    (Eval("KHACHHANG") != null) ? Eval("KHACHHANG.TENKH") : Eval("THONGTINKH")
                                %>
                            </ItemTemplate>
                        </asp:TemplateField>
                        ...
                        <asp:BoundField HeaderText="Điện thoại" DataField="SDT" HeaderStyle-Width="70px" />
                        <asp:TemplateField HeaderText="Ngày phân công" HeaderStyle-Width="100px">
                            <ItemTemplate>
                                <%# (Eval("NGAYPHANCONG") != null) ?
                                        String.Format("{0:dd/MM/yyyy}", Eval("NGAYPHANCONG"))
                                        : "" %>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Nhân viên xử lý" HeaderStyle-Width="100px">
                            <ItemTemplate>
                                <%# (Eval("NHANVIEN1") != null) ?  Eval("NHANVIEN1.HOTEN") : "" %>
                            </ItemTemplate>
                        </asp:TemplateField>
                    </Columns>
                </eoscrm:Grid>            
