...
{
    public partial class CapNhatSauSuaChua : Authentication
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                Authenticate(Functions.SC_CapNhatChiTietSauSuaChua, Permission.Read);
        ...
        {
            Page.Title = Resources.Message.TITLE_SC_CAPNHATSAUSUACHUA;

            var header = (Header)Master.FindControl("header");
            if (header != null)
            {
                header.ModuleName = Resources.Message.MODULE_SUACHUA;
                header.TitlePage = Resources.Message.PAGE_SC_CAPNHATSAUSUACHUA;
            }
        ...
        protected void cboTrangThaiDon_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (cboTrangThaiDon.Text == "SC_F")
            {
                chkIsLapChietTinh.Enabled = false;
                chkIsLapChietTinh.Checked = false;
            }
        ...
        private void BindDSCToForm(GIAIQUYETTHONGTINSUACHUA obj)
        {
            ...
            var xl = cboMAXL.Items.FindByValue(obj.MAXL);
            if (xl != null)
                cboMAXL.SelectedIndex = cboMAXL.Items.IndexOf(xl);
