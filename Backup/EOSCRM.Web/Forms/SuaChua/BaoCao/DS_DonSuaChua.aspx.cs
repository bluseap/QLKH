...
{
    public partial class DS_DonSuaChua : Authentication
    {
        ...
        private void LayBaoCao()
        {
            ...
            var dt = new ReportClass().RpdsDonSuaChua(TuNgay, DenNgay, cboKhuVuc.SelectedValue).Tables[0];
        ...
        void SetTitle(ReportDocument rp)
        {
            ...
            if (txtTitle != null)
                txtTitle.Text = "DANH SÁCH ĐƠN SỬA CHỮA";
        ...
        private void ReLoadBaoCao()
        {
            ...
            var dt = Session["DS_DonSuaChua"] as DataTable;
            rp = new ReportDocument();
            var path = Server.MapPath("../../../Reports/SuaChua/DS_DonSuaChua.rpt");
            rp.Load(path);
