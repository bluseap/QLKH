<%@ Page Language="C#" MasterPageFile="~/Shared/EOS.Master" AutoEventWireup="true"
    CodeBehind="DS_DonSuaChua_HoanThanh.aspx.cs" Inherits="EOSCRM.Web.Forms.SuaChua.BaoCao.DS_DonSuaChua_HoanThanh" %>
    ...
    <div class="crmcontainer">
        <table class="crmtable">
            <tbody>
                ...
                <tr>
                    <td class="crmcell right">Nhân viên xử lý</td>
                    <td class="crmcell">    
                        <div class="left">
                            <asp:DropDownList ID="cboNhanVienXuLy" runat="server" Width="200px" />
                        </div>
                        <div class="left">
                            <div class="right">Thu ngân</div>
                        </div> 
                        <div class="left">
                            <asp:DropDownList ID="cboThuNgan" runat="server" Width="200px" />
                        </div>                         
                    </td>
                </tr>
                <tr>
                    ...
                    <td class="crmcell">    
                        <div class="left">
                            <asp:DropDownList ID="cboLoaiXuLy" runat="server" Width="200px" />
                        </div>
                        <div class="left">
                            <div class="right">Nhóm theo</div>
                        </div>
                        <div class="left">
                            <asp:DropDownList ID="cboNhomTheo" runat="server" Height="24px" Width="200px">
                                <asp:ListItem Value="1">Nhân viên xử lý</asp:ListItem>
                                <asp:ListItem Value="2">Nhân viên ghi chỉ số</asp:ListItem>
                                <asp:ListItem Value="3">Loại xử lý</asp:ListItem>
                            </asp:DropDownList>
                        </div>
                    </td>
                </tr>
