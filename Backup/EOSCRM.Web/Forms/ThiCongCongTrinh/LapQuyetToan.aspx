<%@ Page Language="C#" MasterPageFile="~/Shared/EOS.Master" AutoEventWireup="true" EnableEventValidation="true"
    CodeBehind="LapQuyetToan.aspx.cs" Inherits="EOSCRM.Web.Forms.ThiCongCongTrinh.LapQuyetToan" %>
...
<asp:Content ID="head" ContentPlaceHolderID="headCPH" runat="server">
    <script type="text/javascript">
        ...
        function UpdateCTCTQT(maDDK, maVT, txtSLId, txtGIAVTId, lblTIENVT, txtGIANCId, lblTIENNC) {
		    ...
		    var msg = EOSCRM.Web.Common.AjaxCRM.UpdateCTCTQT(maDDK, maVT, sl, gvt, gnc);		    
		...
		function UpdateCTCT117QT(maDDK, maVT, txtSLId, txtGIAVTId, lblTIENVT, txtGIANCId, lblTIENNC) {
		    openWaitingDialog();
		    unblockWaitingDialog();
		    ...
		    var msg = EOSCRM.Web.Common.AjaxCRM.UpdateCTCT117QT(maDDK, maVT, sl, gvt, gnc);		    
		...
		function UpdateCPCT117QT(maCP, txtNDclientId, txtDGclientId, ddlDVTclientId, txtSLclientId, 
		    txtHSclientId, lblTTclientId, ddlLCPclientId) {
		    openWaitingDialog();
		    unblockWaitingDialog();
		    ...
		    var msg = EOSCRM.Web.Common.AjaxCRM.UpdateCPCT117QT(maCP, nd, dg, dvt, sl, hs, loai);		    
...
<asp:Content ID="content" ContentPlaceHolderID="ContentPlaceHolderMain" runat="server">
                ...
                <asp:TemplateField HeaderText="Hoạt động" HeaderStyle-Width="80px">
                    <ItemTemplate>
                        <asp:LinkButton ID="lnkBtnID2" runat="server" CommandArgument='<%# Eval("MADDK") %>'
                            CommandName="EditItem" Text='Lập quyết toán'></asp:LinkButton>
                    </ItemTemplate>
                </asp:TemplateField>
            </Columns>
        </eoscrm:Grid>
    ...
    <asp:UpdatePanel ID="upnlCustomers" UpdateMode="Conditional" runat="server">
        <ContentTemplate>
            ...
            <table class="crmcontainer">
		        ...
		        <tr>
                    <td class="header">Chi phí đào lắp khách hàng thanh toán</td> 
		        </tr>
		        <tr>
		            <td>
		                <table class="crmtable">
	...
	<div class="crmcontainer p-5">
        <a href="DuyetQuyetToan.aspx">Chuyển sang bước kế tiếp</a>
    </div>
</asp:Content>
