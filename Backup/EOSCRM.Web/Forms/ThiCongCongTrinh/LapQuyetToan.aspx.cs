...
namespace EOSCRM.Web.Forms.ThiCongCongTrinh
{
    public partial class LapQuyetToan : Authentication
    {
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            var msg = qtDao.Update(objUi, CommonFunc.GetComputerName(), CommonFunc.GetIpAdddressComputerName(), LoginInfo.MANV);
        ...
        protected void btnCapNhatGiaTri_Click(object sender, EventArgs e)
        {
            ...
            qtDao.Update(objUi, CommonFunc.GetComputerName(), CommonFunc.GetIpAdddressComputerName(), LoginInfo.MANV);
