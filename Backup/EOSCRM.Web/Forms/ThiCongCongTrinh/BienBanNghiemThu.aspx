                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="crmcell">    
                                ...
                                <div class="left">
                                    <asp:Label ID="lblTENDP1" runat="server" Text="diachi"></asp:Label>
                                </div>                                                      
                            </td>
                        </tr>                        
                        <tr>
                            ...
                            <td class="crmcell">
                                <div class="left width-200">
                                    <asp:Label ID="lbDANHSO" runat="server" Text="danhso"></asp:Label>
                                </div>
                                <div class="left">
                                    <div class="right">Địa chỉ</div>
                                </div>
                        ...
                        <tr>
                            ...
                            <td class="crmcell">
                                <div class="left width-200">
                                    <asp:Label ID="lbKICHCO" runat="server" Text="kichco"></asp:Label>
                                </div>
                                <div class="left">
                        ...
                        <tr>
                            ...
                            <td class="crmcell">
                                <div class="left width-200">
                                    <asp:Label ID="lbSONO" runat="server" Text="danhso"></asp:Label>
                                </div>
                                <div class="left">
                        ...
                        <tr>
                            <td class="crmcell right">Chì niêm mặt 1</td>
                            <td class="crmcell">
                                <div class="left width-200">
                                    <asp:TextBox ID="txtCHIM1" runat="server"></asp:TextBox>
                                </div>
                                <div class="left">
                                    <div class="right">Chì niêm mặt 2</div>
                                </div>
                                <div class="left">
                        ...
                        <tr>
                            ...
                            <td class="crmcell">
                                <div class="left">
                                    <asp:TextBox ID="txtKETLUAN" runat="server" Width="600px" ReadOnly="True"></asp:TextBox>
                                </div>
                            </td>
                        </tr>
                        <tr>
