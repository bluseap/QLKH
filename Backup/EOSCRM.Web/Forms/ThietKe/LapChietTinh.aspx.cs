...
namespace EOSCRM.Web.Forms.ThietKe
{
    public partial class LapChietTinh : Authentication
    {
                ...
                if (!Page.IsPostBack)
                {
                   ...
                   // truong hop back tu form report
                    if (Session["LAPCHIETTINH_MADDK"] != null && FromReport)
                    {
                        ...
                        if (mp.MAPHUONG != null) { timkv(mp.MAPHUONG); }
                        else { ddlPHUONG.Items.Add(new ListItem("Tất cả", "%")); }
        ...
        public void timkv(string maphuong)
        {
            ...
            var phuong = _phuongDao.Get(maphuong);
        ...
        private void ChayChietTinh(THIETKE tk, NHANVIEN nv)
        {
            ...
            if (ct == null)
            {
                ...
                var result = ctDao.CreateChietTinh2(tk, CommonFunc.GetComputerName(), CommonFunc.GetIpAdddressComputerName(), nv.MANV);
