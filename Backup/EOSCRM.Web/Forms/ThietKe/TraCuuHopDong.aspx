...
<%@ Page Language="C#" MasterPageFile="~/Shared/EOS.Master" AutoEventWireup="true" 
    CodeBehind="TraCuuHopDong.aspx.cs" Inherits="EOSCRM.Web.Forms.ThietKe.TraCuuHopDong" %>
                ...
                <table class="crmtable">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="crmcell">
                                <div class="left">
                                    <asp:TextBox ID="txtMADP" runat="server" MaxLength="4" Width="40px" 
                                        TabIndex="7" />
                                </div>
                                <div class="left">/</div>
                                <div class="left">
                                    <asp:TextBox ID="txtDUONGPHU" runat="server" MaxLength="1" Width="40px" 
                                        TabIndex="8" />
                                </div>
                                <div class="left">
