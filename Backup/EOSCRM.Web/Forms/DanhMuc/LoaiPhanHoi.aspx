<%@ Page Language="C#" MasterPageFile="~/Shared/EOS.master" AutoEventWireup="True"
    Inherits="EOSCRM.Web.Forms.DanhMuc.LoaiPhanHoi" CodeBehind="LoaiPhanHoi.aspx.cs" %>
                ...
                <table class="crmtable">
                    <tbody>
                        <tr>    
                            ...
                            <td class="crmcell"> 
                                <div class="left">
                                    <asp:TextBox ID="txtMALOAI" runat="server" Width="50px" MaxLength="10" TabIndex="1" />
                                </div>
                                <div class="left width-175">
                                    <div class="right">Tên loại</div>
                                </div>
                                <div class="left">
                                    <asp:TextBox ID="txtTENLOAI" runat="server" Width="250px" MaxLength="50" TabIndex="1" />
                                </div>
                            </td>
                        </tr>
                        <tr>    
        ...
        <ContentTemplate>
            <div class="crmcontainer">
                <eoscrm:Grid ID="gvList" runat="server" UseCustomPager="true" OnRowDataBound="gvList_RowDataBound" 
                    ...
                    <PagerSettings FirstPageText="loại phản hồi" PageButtonCount="2" />
                    <Columns>
                       <asp:TemplateField HeaderStyle-CssClass="checkbox">
                            ...
                            <ItemTemplate>
                                <input id="Id" runat="server" type="hidden" value='<%# Eval("MALOAI") %>' />
                                <input name="listIds" type="checkbox" value='<%# Eval("MALOAI") %>' />
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Mã loại" HeaderStyle-Width="20%">
                            <ItemTemplate>
                                <asp:LinkButton ID="lnkBtnID" runat="server" CommandArgument='<%# Eval("MALOAI") %>'
                                    CommandName="EditItem" Text='<%# Eval("MALOAI") %>'></asp:LinkButton>
                            </ItemTemplate>
                            <ItemStyle Font-Bold="True" />
                        </asp:TemplateField>
                        <asp:BoundField HeaderStyle-Width="78%" DataField="TENLOAI" HeaderText="Tên loại" />
                    </Columns>
                </eoscrm:Grid>        
            </div>
        </ContentTemplate>
