...
{
    public partial class DoViPham : Authentication
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                Authenticate(Functions.TRUYTHU_DoViPham, Permission.Read);
        ...
        {
            Page.Title = Resources.Message.TITLE_TRUYTHU_DOVIPHAM;

            var header = (Header)Master.FindControl("header");
            if (header != null)
            {
                header.ModuleName = Resources.Message.MODULE_TRUYTHU;
                header.TitlePage = Resources.Message.PAGE_TRUYTHU_DOVIPHAM;
            }
        ...
        private void BindData()
        {
            ...
            var list = _gcsDao.GetListForUpdateTT(kynay, txtSODB.Text.Trim(), kh.MADP);
        ...
        protected void gvList_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            var txtTIENTRUYTHU = e.Row.FindControl("txtTIENTRUYTHU") as TextBox;

            if (hfGCS == null || txtCHISODAU == null || txtCHISOCUOI == null ||
                txtKLTIEUTHU == null ||
                txtMTRUYTHU == null || txtTIENTRUYTHU == null) return;
            ...
            txtMTRUYTHU.Attributes.Add("onkeydown", onKeyDownEventHandler + ", 4, event);");
            txtTIENTRUYTHU.Attributes.Add("onkeydown", onKeyDownEventHandler + ", 5, event);");
            ...
            txtTIENTRUYTHU.Attributes.Add("onfocus", "javascript:onFocusEventHandler(\"" + txtTIENTRUYTHU.ClientID + "\");");
           ...
           try
        {
            ...
            {
                ((TextBox)e.Row.FindControl("txtTIENTRUYTHU")).Text = int.Parse("0" + ((TextBox)e.Row.FindControl("txtTIENTRUYTHU")).Text).ToString("#,###");
            }
        }
        catch { }
