...
{
    public partial class Dsktky : Authentication
    {
        ...
        protected void btnBaoCao_Click(object sender, EventArgs e)
        {
            ...
            {
                CloseWaitingDialog();
                ShowError("Vui lòng chọn đường phố để báo cáo", txtMADP.ClientID);
                return;
            }

            var dtDSKTKY =
                new ReportClass().Dsktky(int.Parse(ddlTHANG.Text.Trim()), int.Parse(txtNAM.Text.Trim()), str_madp).
                    Tables[0];
            ...
            if (dtDSKTKY.Rows.Count > 0)
            {
                ...
                CloseWaitingDialog();
                Page.Response.Redirect(ResolveUrl("~") + "Forms/GhiChiSo/BaoCao/rpDSKTKY.aspx");
            }
            else
            {
                CloseWaitingDialog();
