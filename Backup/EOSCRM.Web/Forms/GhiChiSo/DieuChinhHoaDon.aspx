            ...
            <div class="crmcontainer">
                <table class="crmtable">
                    <tbody>
                            ...
                            <td class="crmcell">    
                                <div class="left">
                                    <asp:TextBox ID="txtSODB" runat="server" 
                                        MaxLength="8" Width="90px" TabIndex="7" ReadOnly="True" onchange="CheckSearchKH();"
                                        />
                                </div>
                                <div class="left">
                        ...
                        <tr>
                            <td class="crmcell right">Mã số hoá đơn sai</td>
                            <td class="crmcell">
                                <div class="left width-100">
                                    <asp:TextBox ID="txtMASOHD" runat="server" Width="120px" MaxLength="20" TabIndex="2" />
                                </div>                                
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td class="crmcell">
                                <div class="left width-100">
                                    <asp:TextBox ID="txtCSMOI" runat="server" Width="50px" MaxLength="10" TabIndex="2" />
                                </div>
                                <div class="left">
                                    <div class="right">CS Cũ</div>
                                </div>
                                <div class="left width-100">
                                    <asp:TextBox ID="txtCSCU" runat="server" Width="50px" MaxLength="10" TabIndex="2" />
                                </div>                                
                            </td>
                        </tr>                        
                        <tr>    
