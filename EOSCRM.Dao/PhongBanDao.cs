...
namespace EOSCRM.Dao
{
    public  class PhongBanDao
    {
        ...
        public List<PHONGBAN> GetListPB(string mapb)
        {
            return _db.PHONGBANs.Where(p => p.MAPB.Equals(mapb)).ToList();
        }

        public List<PHONGBAN> GetListKV(string makv)
        {
            return _db.PHONGBANs.Where(p => p.MAKV.Equals(makv)).ToList();
        }
