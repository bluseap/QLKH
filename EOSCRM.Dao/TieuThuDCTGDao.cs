...
namespace EOSCRM.Dao
{
    public class TieuThuDCTGDao
    {
        ...
        public TieuThuDCTGDao()
        {
            _db = new EOSCRMDataContext(Connectionstring);
        }


        public TIEUTHUDCTG Get(string ma)
        {
            return _db.TIEUTHUDCTGs.FirstOrDefault(p => p.IDKH.Equals(ma));
        }

        public TIEUTHUDCTG GetTNTG(string ma, int thang, int nam)
        {
            return _db.TIEUTHUDCTGs.FirstOrDefault(p => p.IDKH.Equals(ma) && p.THANG.Equals(thang) && p.NAM.Equals(nam));
        }

        public Message Insert(TIEUTHUDCTG objUi, String useragent, String ipAddress, String sManv)
        {
            Message msg;
            try
            {
                ...
                _db.TIEUTHUDCTGs.InsertOnSubmit(objUi);
                _db.SubmitChanges();
                ...
                var luuvetKyduyet = new LUUVET_KYDUYET
                {
                    ...
                    MOTA = "Điều chỉnh hoá đơn tăng, giảm."
                };
        ...
        public Message Update(TIEUTHUDCTG obj)
        {
            Message msg;
            ...
            try
            {
                ...
                var objDb = _db.TIEUTHUDCTGs.SingleOrDefault(tt => tt.IDKH == obj.IDKH &&
                                                               tt.NAM == obj.NAM &&
                                                               tt.THANG == obj.THANG);
                if (objDb == null)
        ...
        public List<TIEUTHUDCTG1> GetDCTG(string khuvuc, int thang, int nam)
        {
            var q = _db.TIEUTHUDCTGs
            ...
            return q.Select(@res => new
            {
                ...
                @res.tt.GHICHUDC,
                @res.tt.MASOHDDC
            }).AsEnumerable().Select(x => new TIEUTHUDCTG1
            {
                IDKH = x.IDKH,
                SODB = x.SODB,
                MADP = x.MADP,
        ...
        public List<TIEUTHUDCTG1> GetDCTG1(int thang, int nam)
        {
            var q = _db.TIEUTHUDCTGs
                .Join(_db.KHACHHANGs, tt => tt.IDKH.Trim(), kh => kh.IDKH.Trim(),
                    (tt, kh) => new { tt, kh })
    ...
    public class TIEUTHUDCTG1
    {
        ...
        public TIEUTHUDCTG1(string idkh, string soDb, string madp, int nam, int thang, string sonha, string tenkh,
            ...
            decimal? mtruythudc, string ghichudc, string masohddc)
        {
