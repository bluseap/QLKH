...
namespace EOSCRM.Dao
{
    public  class ThietKeDao
    {
        ...
        public THIETKE  Get(string ma)
        {
            return _db.THIETKEs.SingleOrDefault(p => p.MADDK.Equals(ma));
        }

        public Message Insert(THIETKE objUi, String useragent, String ipAddress, String sManv)
        {
            Message msg;
            ...
            try
            {
                ...
                // insert to thietke
                _db.THIETKEs.InsertOnSubmit(objUi);
                _db.SubmitChanges();

                // change dondangky's TTTK field to TK_P
                objUi.DONDANGKY.TTTK = TTTK.TK_P.ToString();
                _db.SubmitChanges();
        ...
        public Message InsertTKSC(THIETKE objUi)
        {
            Message msg;
            try
            {
        ...
        public Message Update(THIETKE objUi, String useragent, String ipAddress, String sManv)
        {
            Message msg;
            try
            {
                ...
                if (objDb != null)
                {
                    ...
                    objDb.SDTTK = objUi.SDTTK;
                    objDb.VITRIDHTK = objUi.VITRIDHTK;
                    objDb.NGAYTRAHSKD = objUi.NGAYTRAHSKD;
        ...
        public Message UpdateHinh1(THIETKE objUi, String useragent, String ipAddress, String sManv)
        {
            Message msg;
            try
            {
        ...
        public Message UpdateHinh2(THIETKE objUi, String useragent, String ipAddress, String sManv)
        {
            Message msg;
            try
            {
        ...
        public Message UpdateTongTien(THIETKE objUi, String useragent, String ipAddress, String sManv)
        {
            Message msg;
            try
            {
        ...
        public Message Delete(THIETKE objUi, String useragent, String ipAddress, String sManv)
        {
            Message msg;
            ...
            try
            {
                ...
                // Set delete info
                _db.THIETKEs.DeleteOnSubmit(objDb);
                // Submit changes to db
                _db.SubmitChanges();
        ...
        /// <returns></returns>
        public Message DeleteList(List<THIETKE> objList, PageAction action, String useragent, String ipAddress, String sManv)
        {
            Message msg;
            DbTransaction trans = null;
        ...
        public Message ChangeFromMBVT(THIETKE objUi, MAUBOCVATTU mbvt)
        {
            Message msg;
            DbTransaction trans = null;
            ...
            try
            {
                ...
                if (mbvt != null)
                {
                    ...
                    var cttk = _db.CTTHIETKEs.Where(ct => ct.MADDK.Equals(objUi.MADDK)).ToList();
                    foreach (var ct in cttk)
                    {
                        _db.CTTHIETKEs.DeleteOnSubmit(ct);
                    }

                    var gctk = _db.GCTHIETKEs.Where(gc => gc.MAMBVT.Equals(objUi.MADDK)).ToList();
                    foreach (var gc in gctk)
                    {
                        _db.GCTHIETKEs.DeleteOnSubmit(gc);
                    }

                    var cptk = _db.DAOLAPTKs.Where(cp => cp.MADDK.Equals(objUi.MADDK)).ToList();
                    ...
                    foreach (var cp in cpmbvt)
                    {
                        var newCptk = new DAOLAPTK
                        {
                            ...
                            LOAI = cp.LOAI,
                            NGAYLAP = cp.NGAYLAP,
                            CHIEUCAO = cp.CHIEUCAO,
                            CHIEURONG = cp.CHIEURONG,
                            KYHIEUVT = cp.LOAICP == "DAO" ? "AB.11512" : (cp.LOAICP == "LAP" ? "AB.13121" : "")
                        };
        ...
        public Message UpdateGhiChuTK(string maddk, string ghichuthietke, string useragent, string ipAddress, string sManv)
        {
            Message msg;
            try
            {
