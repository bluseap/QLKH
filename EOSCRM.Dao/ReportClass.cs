...
public class ReportClass
{
    ...
    public DataSet Get_DSTongHopKHDK_ByKVToDung7Ngay(string khuVuc, string mapb, DateTime tuNgay, DateTime denNgay)
    {
        Database db = new Database();
        SqlParameter[] prams = {
                    db.MakeInParam("@MaKV", SqlDbType.VarChar  , 10, khuVuc ),
    ...
    public DataSet Get_DSTongHopKHDK_ByDuyetCTKoTC(string khuVuc, string mapb, DateTime tuNgay, DateTime denNgay)
    {
        Database db = new Database();
        SqlParameter[] prams = {
                    db.MakeInParam("@MaKV", SqlDbType.VarChar  , 10, khuVuc ),
        ...
        DataSet ds = db.RunExecProc("Get_DSTongHopKHDK_ByDuyetCTKoTC", prams);
        db.Dispose();
        return ds;
    }

    public DataSet Get_DSTongHopKHDK_ByDuyetCTKoTCPo(string khuVuc, string mapb, DateTime tuNgay, DateTime denNgay)
    {
        Database db = new Database();
        SqlParameter[] prams = {
                    db.MakeInParam("@MaKV", SqlDbType.VarChar  , 10, khuVuc ),
        ...
        DataSet ds = db.RunExecProc("Get_DSTongHopKHDK_ByDuyetCTKoTCPo", prams);
        db.Dispose();
        return ds;
    }
