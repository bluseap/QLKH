...
{
    public class KhachHangTamLXDao
    {
        ...
        public KhachHangTamLXDao()
        {
            _db = new EOSCRMDataContext(Connectionstring);
        }
        
        public KHACHHANGTAMLX Get(string ma)
        {
            return _db.KHACHHANGTAMLXes.FirstOrDefault(p => p.IDKH.Equals(ma));
        }

        public KHACHHANGTAMLX GetMADDK(string ma)
        {
            return _db.KHACHHANGTAMLXes.FirstOrDefault(p => p.MADDK.Equals(ma));
        }

        public KHACHHANGTAMLX GetKhachHangFromMadb(string MAKH)
        {
            return _db.KHACHHANGTAMLXes.FirstOrDefault(p => (p.MADP + p.DUONGPHU + p.MADB) == MAKH);
        }

        public KHACHHANGTAMLX GetKHDBKV(string MAKH, string makv)
        {
            return _db.KHACHHANGTAMLXes.FirstOrDefault(p => (p.MADP + p.DUONGPHU + p.MADB) == MAKH && p.MAKV == makv);
        }

        public List<KHACHHANGTAMLX> GetList()
        {
            return _db.KHACHHANGTAMLXes.ToList();
        }

        public List<KHACHHANGTAMLX> GetList(string madp)
        {
            return _db.KHACHHANGTAMLXes.Where(kh => kh.MADP.Equals(madp))
                //.OrderBy(kh => kh.STT).ToList();
                .OrderBy(kh => kh.MADP).OrderBy(kh => kh.MADB).OrderBy(kh => kh.STT).ToList();
        }

        public List<KHACHHANGTAMLX> GetListTS(string madp)
        {
            return _db.KHACHHANGTAMLXes.Where(kh => kh.MADP.Equals(madp))
                .OrderBy(kh => kh.STT).OrderBy(kh => kh.MADP).OrderBy(kh => kh.MADB).ToList();
        }

        public List<KHACHHANGTAMLX> GetList(string madp, int fromStt, int toStt)
        {
            return _db.KHACHHANGTAMLXes.Where(kh => kh.MADP.Equals(madp) &&
                                                kh.STT >= fromStt &&
                                                kh.STT <= toStt)
        ...
        public List<KHACHHANGTAMLX> SearchKhachHang(string maDanhBo, string tenKhachHang, string maDongHo, string soHopDong, string soNha, string duongPho, string maKv)
        {
            if (maDanhBo == "" && tenKhachHang == "" && maDongHo == "" && soHopDong == "" && soNha == "" && duongPho == "" && (maKv == "" || maKv == "NULL"))
                return null;

            var query = _db.KHACHHANGTAMLXes.Where(kh => kh.XOABOKH == false)
                .AsEnumerable();
        ...
        public int Count( )
        {
            return _db.KHACHHANGTAMLXes.Count();
        }


        public Message Insert(KHACHHANGTAMLX objUi, String useragent, String ipAddress, String sManv)
        {
            Message msg;
            try
            {
                var count = _db.KHACHHANGTAMLXes.Count(kh => kh.IDKH.Equals(objUi.IDKH) ||
                                                       (objUi.IDKH != null &&
                ...
                // insert to KHACHHANG
                _db.KHACHHANGTAMLXes.InsertOnSubmit(objUi);
                ...
                var luuvetKyduyet = new LUUVET_KYDUYET
                {
                    ...
                    MATT = "INKHTAMLX",
                    MOTA = "Nhập khách hàng mới tạm LX."
                };
        ...
        public Message InsertLX(KHACHHANGTAMLX objUi, String useragent, String ipAddress, String sManv)
        {
            Message msg;
            try
            {
        ...
        public Message InsertTS(KHACHHANGTAMLX objUi, String useragent, String ipAddress, String sManv)
        {
            Message msg;
            try
            {
        ...
        public Message InsertTS2(KHACHHANGTAMLX objUi, String useragent, String ipAddress, String sManv)
        {
            Message msg;
            try
            {
        ...
        public Message UpdateTTSD(KHACHHANGTAMLX obj, int thang, int nam, string ghichu, String useragent, String ipAddress, String sManv)
        {
            Message msg;
            try
            {
        ...
        public Message UpdateThayDongHo(KHACHHANGTAMLX obj, DateTime ngayht, string tem, string ghichu, String useragent, String ipAddress, String sManv,
        ...
        public Message UpdateSoBo(KHACHHANGTAMLX moi, String useragent, String ipAddress, String sManv)
        {
            Message msg;
            try
            {
        ...
        public Message UpdateSoBoDungPhim(KHACHHANGTAMLX moi, String useragent, String ipAddress, String sManv)
        {
            Message msg;
            try
            {
        ...
        public Message UpdateSoBoTachDuong(KHACHHANGTAMLX moi, String useragent, String ipAddress)
        {
            Message msg;
            try
            {
        ...
        public Message UpdateSoBoTachDuongTSon(KHACHHANGTAMLX moi, String useragent, String ipAddress)
        {
            Message msg;
            try
            {
        ...
        {
            var query = (from p in _db.KHACHHANGTAMLXes.Where(p => p.MADP.Equals(madp) && p.MADB.Equals(madb))
                        select p.MADP).Count();
            
            return query;
        }

        public Message UpdateMaDoan(KHACHHANGTAMLX moi, String useragent, String ipAddress, String sManv)
        {
            Message msg;
            try
            {
        ...
        public Message UpdateKHMCSC(KHACHHANGTAMLX moi, String useragent, String ipAddress, String sManv)
        {
            Message msg;
            try
            {
        ...
        public Message Update(KHACHHANGTAMLX moi, int nam, int thang, String useragent, String ipAddress, String sManv)
        {
            Message msg;
            try
            {
        ...
        {
            return
                (_db.KHACHHANGTAMLXes.Count(p => (p.IDKH.Equals(idkh) || string.IsNullOrEmpty(idkh)) && p.MADP.Equals(madp) && p.MADB.Equals(madb)) > 0);
        ...
        {
            return
                (_db.KHACHHANGTAMLXes.Count(p => p.MADP.Equals(madp) && p.MADB.Equals(madb)) > 1);
        ...
        {
            return
                (_db.KHACHHANGTAMLXes.Count(p => (p.IDKH.Equals(idkh) || string.IsNullOrEmpty(idkh)) && p.MADP.Equals(madp) && p.MADB.Equals(madb)) > 1);

        }

        public Message Delete(KHACHHANGTAMLX objUi, String useragent, String ipAddress, String sManv)
        {
            Message msg;
            ...
            try
            {
                ...
                // Set delete info
                _db.KHACHHANGTAMLXes.DeleteOnSubmit(objDb);
        ...
        public Message DeleteList(List<KHACHHANGTAMLX> objList, PageAction action, String useragent, String ipAddress, String sManv)
        {
            Message msg;
            DbTransaction trans = null;
        ...
        public string NewIDKHLX()
        {
            var query = _db.KHACHHANGTAMLXes.Max(p => p.IDKHLX);            
        ...
        public string NewId()
        {
            var query = _db.KHACHHANGTAMLXes.Max(p => p.IDKH);
            var khquery = int.Parse(_db.KHACHHANGs.Max(p => p.IDKH)) + 1 ;
            ...
            return khquery.ToString("D6");
        }

        public string NewMADB(string maDP)
        {
            var query = (from p in _db.KHACHHANGTAMLXes.Where(p => p.MADP.Equals(maDP))
                        select p.MADB).Max();
            if (!string.IsNullOrEmpty(query))
            {
                var bn = 20;
        ...
        public List<KHACHHANGTAMLX> GetListInKKT(int thang, int nam)
        {
            return _db.KHACHHANGTAMLXes.Where(k => (k.THANGBDKT.HasValue && 
        ...
        public List<KHACHHANGTAMLX> GetListKH(int thang, int nam)
        {
            return _db.KHACHHANGTAMLXes.Where(k => k.KYKHAITHAC.Month == thang && k.KYKHAITHAC.Year == nam)
                                            .OrderByDescending(k => k.IDKH).ToList();
        }

        public List<KHACHHANGTAMLX> GetListKHKV(int thang, int nam, string makv)
        {
            return _db.KHACHHANGTAMLXes.Where(k => k.KYKHAITHAC.Month == thang && k.KYKHAITHAC.Year == nam && k.MAKV.Equals(makv))
                                            .OrderByDescending(k => k.IDKH).ToList();
        }

        public List<KHACHHANGTAMLX> GetList(String IDKH, String SOHD, String MADH, String TENKH, String SONHA, String TENDP, String MAKV, String GHI2THANG1LAN)
        {
            //var dskh = from kh in _db.KHACHHANGs
            //           select kh;

            var dskh = from kh in _db.KHACHHANGTAMLXes
        ...
        {
            return _db.KHACHHANGTAMLXes.Where(lck => lck.KYKHAITHAC.Month.Equals(kyghi.Month)
