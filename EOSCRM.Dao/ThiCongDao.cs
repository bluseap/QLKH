...
namespace EOSCRM.Dao
{
    public  class ThiCongDao
    {
        ...
        public THICONG GetMADH(string madh)
        {
            return _db.THICONGs.SingleOrDefault(p => p.MADH.Equals(madh));
        }
        ...
        public List<THICONG> GetListDangThiCongKV(string maKV)
        {
            return _db.THICONGs.Where(tc => tc.DONDANGKY.TTTC.Equals(TTTC.TC_P.ToString()) && tc.DONDANGKY.MAKV.Equals(maKV))
                .OrderByDescending(tc => tc.NGAYGTC)
                .ToList();
        }

        public List<THICONG> GetListDangThiCongPo()
        {
            return _db.THICONGs.Where(tc => tc.DONDANGKYPO.TTTC.Equals(TTTC.TC_P.ToString()))
                .OrderByDescending(tc => tc.NGAYGTC)
                .ToList();
        }

        public List<THICONG> GetListDangThiCongPoKV(string makv)
        {
            return _db.THICONGs.Where(tc => tc.DONDANGKYPO.MAKVPO.Equals(makv) && tc.DONDANGKYPO.TTTC.Equals(TTTC.TC_P.ToString()))
                .OrderByDescending(tc => tc.NGAYGTC)
                .ToList();
        }
        ...
        public List<THICONG> GetListDangThiCongKV(String madon, String tenkh, String sonha, String tenduong,
            String tenphuong, String tenkv, String manv, String tennv, DateTime? fromdate, DateTime? todate, string maKV)
        {
            var query = _db.THICONGs.Where(tc => tc.DONDANGKY.TTTC.Equals(TTTC.TC_P.ToString()) && tc.DONDANGKY.MAKV.Equals(maKV)).AsQueryable();
        ...
        public List<THICONG> GetListDangThiCongPo(String madon, String tenkh, String sonha, String tenduong,
            String tenphuong, String tenkv, String manv, String tennv, DateTime? fromdate, DateTime? todate, string makv)
        {
            var query = _db.THICONGs.Where(tc => tc.DONDANGKYPO.MAKVPO.Equals(makv) && tc.DONDANGKYPO.TTTC.Equals(TTTC.TC_P.ToString())).AsQueryable();

            if (!String.IsNullOrEmpty(madon))
                query = query.Where(tc => tc.MADDK.Contains(madon)).AsQueryable();

            if (!String.IsNullOrEmpty(tenkh))
                query = query.Where(tc => tc.DONDANGKYPO.TENKH.Contains(tenkh)).AsQueryable();
            if (!String.IsNullOrEmpty(sonha))
                query = query.Where(tc => tc.DONDANGKYPO.DIACHILD.Contains(sonha)).AsQueryable();
            if (!String.IsNullOrEmpty(tenduong))
                query = query.Where(tc => tc.DONDANGKYPO.DIACHILD.Contains(tenduong)).AsQueryable();
            if (!String.IsNullOrEmpty(tenphuong))
                query = query.Where(tc => tc.DONDANGKYPO.DIACHILD.Contains(tenphuong)).AsQueryable();
            if (!String.IsNullOrEmpty(tenkv))
                query = query.Where(tc => tc.DONDANGKYPO.DIACHILD.Contains(tenkv)).AsQueryable();
        ...
        public List<THICONG> GetListDangThiCong2(string makv)
        {
            return _db.THICONGs.Where(tc => tc.DONDANGKY.MAKV.Equals(makv) && (tc.DONDANGKY.TTTC.Equals(TTTC.TC_P.ToString()) ||
                    tc.DONDANGKY.TTTC.Equals(TTTC.TC_A.ToString()) || tc.DONDANGKY.TTTC.Equals(TTTC.TC_RA.ToString())
                    ))
                .OrderByDescending(tc => tc.NGAYGTC)
                .ToList();
        }

        public List<THICONG> GetListDangThiCong2Po(string makv)
        {
            return _db.THICONGs.Where(tc => tc.DONDANGKYPO.MAKVPO.Equals(makv) && (tc.DONDANGKYPO.TTTC.Equals(TTTC.TC_P.ToString()) ||
                    tc.DONDANGKYPO.TTTC.Equals(TTTC.TC_A.ToString())))
                .OrderByDescending(tc => tc.NGAYGTC)
                .ToList();
        }
        ...
        public List<THICONG> GetListDaThiCongPo(String madon, String tenkh, String sonha, String tenduong,
            String tenphuong, String tenkv, String manv, String tennv,
            String madh, int? chiso, String ongnhanh, int? duongkinh, decimal? somet, String soserial, String ghichu,
            DateTime? fromdate, DateTime? todate, string makv)
        {
            var query = _db.THICONGs.Where(tc => tc.DONDANGKYPO.MAKVPO.Equals(makv) && tc.DONDANGKYPO.TTTC.Equals(TTTC.TC_A.ToString())).AsQueryable();

            if (!String.IsNullOrEmpty(madon))
                query = query.Where(tc => tc.MADDK.Contains(madon)).AsQueryable();

            if (!String.IsNullOrEmpty(tenkh))
                query = query.Where(tc => tc.DONDANGKYPO.TENKH.ToLower().Contains(tenkh.ToLower())).AsQueryable();

            if (!String.IsNullOrEmpty(sonha))
                query = query.Where(tc => tc.DONDANGKYPO.SONHA.ToLower().Contains(sonha.ToLower())).AsQueryable();

            if (!String.IsNullOrEmpty(tenduong))
                query = query.Where(tc => tc.DONDANGKYPO.TEN_DC_KHAC.ToLower().Contains(tenduong.ToLower()) ||
                    (tc.DONDANGKYPO.DUONGPHOPO != null && tc.DONDANGKYPO.DUONGPHOPO.TENDP.ToLower().Contains(tenduong.ToLower()))
                    ).AsQueryable();

            if (!String.IsNullOrEmpty(tenphuong))
                query = query.Where(tc => tc.DONDANGKYPO.PHUONGPO != null &&
                    tc.DONDANGKYPO.PHUONGPO.TENPHUONG.ToLower().Contains(tenphuong.ToLower())).AsQueryable();

            if (!String.IsNullOrEmpty(tenkv))
                query = query.Where(tc => tc.DONDANGKYPO.KHUVUCPO != null &&
                    tc.DONDANGKYPO.KHUVUCPO.TENKV.ToLower().Contains(tenkv.ToLower())).AsQueryable();
        ...
        public List<THICONG> GetListTraCuuThiCongKV(string makv)
        {
            return _db.THICONGs.Where(tc => tc.DONDANGKY.MAKV.Equals(makv) && (tc.DONDANGKY.TTTC.Equals(TTTC.TC_A.ToString()) ||
                tc.DONDANGKY.TTTC.Equals(TTTC.TC_P.ToString())))
                .OrderByDescending(tc => tc.NGAYGTC)
                .ToList();
        }

        public List<THICONG> GetListTraCuuThiCongPo()
        {
            return _db.THICONGs.Where(tc => tc.DONDANGKYPO.TTTC.Equals(TTTC.TC_A.ToString()) ||
                tc.DONDANGKYPO.TTTC.Equals(TTTC.TC_P.ToString()))
                .OrderByDescending(tc => tc.NGAYGTC)
                .ToList();
        }

        public List<THICONG> GetListTraCuuThiCongPoKV(string makv)
        {
            return _db.THICONGs.Where(tc => tc.DONDANGKYPO.MAKVPO.Equals(makv) && tc.DONDANGKYPO.TTTC.Equals(TTTC.TC_A.ToString()) ||
                tc.DONDANGKYPO.TTTC.Equals(TTTC.TC_P.ToString()))
                .OrderByDescending(tc => tc.NGAYGTC)
                .ToList();
        }
        ...
        public List<THICONG> GetListTraCuuThiCongKV(String madon, String tenkh, String sonha, String tenduong,
            String tenphuong, String tenkv, String manv, String tennv,
            String madh, int? chiso, String ongnhanh, int? duongkinh, decimal? somet, String soserial, String ghichu,
            DateTime? fromdate, DateTime? todate, string maKV)
        {
            var query = _db.THICONGs.Where(tc => tc.DONDANGKY.MAKV.Equals(maKV) && (tc.DONDANGKY.TTTC.Equals(TTTC.TC_A.ToString()) ||
                tc.DONDANGKY.TTTC.Equals(TTTC.TC_P.ToString()) || tc.DONDANGKY.TTTC.Equals(TTTC.TC_RA.ToString())
                )).AsQueryable();
        ...
        public List<THICONG> GetListTraCuuThiCongPo(String madon, String tenkh, String sonha, String tenduong,
            String tenphuong, String tenkv, String manv, String tennv,
            String madh, int? chiso, String ongnhanh, int? duongkinh, decimal? somet, String soserial, String ghichu,
            DateTime? fromdate, DateTime? todate, string makv)
        {
            var query = _db.THICONGs.Where(tc => tc.DONDANGKYPO.MAKVPO.Equals(makv) && tc.DONDANGKYPO.TTTC.Equals(TTTC.TC_A.ToString()) ||
                tc.DONDANGKYPO.TTTC.Equals(TTTC.TC_P.ToString())).AsQueryable();
        ...
        public Message InsertPower(THICONG objUi, String useragent, String ipAddress, String sManv)
        {
            Message msg;
            DbTransaction trans = null;
            ...
            try
            {
                ...
                var ddk = _db.DONDANGKYPOs.SingleOrDefault(d => d.MADDKPO.Equals(objUi.MADDK));
                if (ddk != null)
                    ddk.TTTC = TTTC.TC_P.ToString();
                else
                {
            ...
            catch (Exception ex)
            {
                ...
                msg = ExceptionHandler.HandleInsertException(ex, "Thi công ", objUi.DONDANGKYPO.TENKH);
            }
            return msg;
        }
        ...
        public Message Update(THICONG objUi, TTTC tttc, String useragent, String ipAddress, String sManv)
        {
            ...
            try
            {
                ...
                if (objDb != null)
                {
                    ...
                    //_rpClass.UPDDKTHICONGA(objUi.MADDK);
                    ...
                    var luuvetKyduyet = new LUUVET_KYDUYET
                    {
                        ...
                        MACN = CHUCNANGKYDUYET.KH01.ToString(),
                        MATT = tttc.ToString(),
                        MOTA = "Cập nhập chi tiết sau thi công."
                    };
                    _kdDao.Insert(luuvetKyduyet);
                    #endregion
        ...
        public Message Update2(THICONG objUi, TTTC tttc, String useragent, String ipAddress, String sManv)
        {
            Message msg;
            DbTransaction trans = null;
            ...
            try
            {
                ...
                if (objDb != null)
                {
                    ...
                    var dasd = _dhDao.Get(objUi.MADH);
                    _dhDao.UpdateDASD(dasd);
                    _dhDao.UpdateDASDMoi(objUi.MADH);
        ...
        public Message UpdateTraHSTCKT(THICONG objUi, TTTC tttc, String useragent, String ipAddress, String sManv)
        {
            Message msg;
            DbTransaction trans = null;
            ...
            try
            {
                ...
                if (objDb != null)
                {
                    ...
                    objDb.NGAYN = DateTime.Now;
                    objDb.LYDOTRAHSTK = objUi.LYDOTRAHSTK;
                    ...
                    {
                        ddk.TTTC = tttc.ToString();
                        ddk.TTTK = TTTK.TK_P.ToString();
                        ddk.TTCT = TTCT.CT_P.ToString();
                    }

                    var thietke = _db.THIETKEs.SingleOrDefault(d => d.MADDK.Equals(objUi.MADDK));
                    if (thietke != null)
                    {
                        thietke.ISTRAKEHOACH = true;
                    }
                    ...
                    var luuvetKyduyet = new LUUVET_KYDUYET
                    {
                        ...
                        MACN = CHUCNANGKYDUYET.KH01.ToString(),
                        MATT = tttc.ToString(),
                        MOTA = "Cập nhập chi tiết sau thi công. Trả HS về KT"
                    };
                    _kdDao.Insert(luuvetKyduyet);
                    #endregion
        ...
        public Message UpdateTraHSTCTKPT(THICONG objUi, TTTC tttc, String useragent, String ipAddress, String sManv)
        {
            Message msg;
            DbTransaction trans = null;
            ...
            try
            {
                ...
                if (objDb != null)
                {
                    ...
                    var luuvetKyduyet = new LUUVET_KYDUYET
                    {
                        ...
                        MACN = CHUCNANGKYDUYET.KH01.ToString(),
                        MATT = tttc.ToString(),
                        MOTA = "Cập nhập chi tiết sau thi công. Trả HS về TK"
                    };
                    _kdDao.Insert(luuvetKyduyet);
                    #endregion
        ...
        public Message UpdatePower(THICONG objUi, TTTC tttc, String useragent, String ipAddress, String sManv)
        {
            Message msg;
            DbTransaction trans = null;
            ...
            try
            {
                ...
                if (objDb != null)
                {
                    ...
                    var luuvetKyduyet = new LUUVET_KYDUYET
                    {
                        ...
                        MOTA = "Cập nhập chi tiết sau thi công điện."
                    };
                    _kdDao.Insert(luuvetKyduyet);
                    #endregion
        ...
        public Message UpdateTraTCToTK(THICONG objUi, TTTC tttc, String useragent, String ipAddress, String sManv)
        {
            Message msg;
            DbTransaction trans = null;
        ...
        public Message UpdatePo(THICONG objUi, String useragent, String ipAddress, String sManv)
        {
            Message msg;
            DbTransaction trans = null;
