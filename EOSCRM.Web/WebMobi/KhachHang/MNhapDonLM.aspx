<%@ Page Title="" Language="C#" MasterPageFile="~/Shared/WebMobi.Master" AutoEventWireup="true" CodeBehind="MNhapDonLM.aspx.cs" Inherits="EOSCRM.Web.WebMobi.KhachHang.MNhapDonLM" %>
    ...
    <div id="divDuongPhoDlgContainer">
        <div id="divDuongPho" style="display: none">
            <asp:UpdatePanel ID="upnlDuongPho" runat="server" UpdateMode="Conditional">
				<ContentTemplate>
				    <table cellpadding="3" cellspacing="1" style="width: 300px;">
                        <tr>
                                ...
                                <table class="crmtable">
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="crmcell">
                                                <div class="left">
                                                    <asp:TextBox ID="txtKeywordDP" onchange="return CheckFormFilterDP();" runat="server" Width="80px" MaxLength="200" />
                                                </div>
                                                <div class="left">
							...
							<td class="ptop-10">
							    <div class="crmcontainer">
							        <eoscrm:Grid ID="gvDuongPho" runat="server" UseCustomPager="true" 
                                        ...
                                        <Columns>
                                            <asp:TemplateField HeaderStyle-Width="10px" HeaderText="Mã ĐP">
                                                <ItemTemplate>
                                            ...
                                            <asp:BoundField HeaderStyle-Width="50px" DataField="TENDP" HeaderText="Tên đường phố" />
                                            <asp:TemplateField HeaderStyle-Width="20px" HeaderText="Khu vực">
                                                <ItemTemplate>
                                                    <%# Eval("KHUVUC.TENKV") %>
                                                </ItemTemplate>
                                            </asp:TemplateField>
        ...
        <ContentTemplate>          
            <div class="container">
                <form class="form-signin" role="form">             
                            <label class="form-signin-heading">Mã đơn đăng ký</label>
                            <asp:TextBox ID="txtMADDK" runat="server" MaxLength="10" class="form-control"
                                        TabIndex="1" OnTextChanged="txtMADDK_TextChanged" /> 
                            <label class="checkbox">
                                    <asp:CheckBox ID="cbDAIDIEN"  runat="server"/>                                
                            </label>
                   
                            <label class="form-signin-heading">Tên trạm</label>                           
                            <asp:DropDownList ID="ddlPHUONG" TabIndex="3" runat="server" class="form-control">
                            </asp:DropDownList>
                        ...
                        <li>
                            ...
                            <td class="crmcell">
                                <div class="left">
                                 ...
                                 <div class="left">
                                    <asp:TextBox ID="txtDMNK" runat="server" Width="10px" MaxLength="20" TabIndex="7" Visible="false"/>
                                </div>
                                <div class="left">
                                    <asp:TextBox ID="txtDINHMUC" runat="server" Width="10px" MaxLength="20" TabIndex="7" Visible="false"/>
                                </div>                              
                            </td>                            
                        </li>                        
                        ...
                        <li>
                            ...
                            <td class="crmcell">
                                <div class="left">
                                    <asp:TextBox ID="txtDIACHIKHAC" runat="server" Width="200px" MaxLength="200" TabIndex="10" />
                                </div>
                            </td>
                        </li>
                        <li>
                        ...
                        <li>
                            <td class="crmcell right">Nơi lắp ĐH nước</td>
                            <td class="crmcell">
                                <div class="left">
                                        <asp:TextBox ID="txtNOILAPDHN" runat="server" Width="200px" MaxLength="200" TabIndex="15" />
                                 </div>
                            </td>
                        </li>
                        <li>
                        ...
                        <li>
                            ...
                            <td class="crmcell">
                                <div class="left">
                                    <asp:TextBox ID="txtNOIDUNG"  Width="200" TabIndex="118"
                        ...
                        <li>
                            ...
                            <td class="crmcell">
                                <div class="left">
                                    <asp:TextBox ID="txtTENKH_INHOADON" MaxLength="200" runat="server" Width="200px" TabIndex="38" />
                                </div>
                            </td>                            
                        </li>
                        <li>
                            ...
                            <td class="crmcell">
                                <div class="left">
                                    <asp:TextBox ID="txtDIACHI_INHOADON" MaxLength="200" runat="server" Width="200px" TabIndex="39" />
                                </div>
                            </td>
                        </li>                        
                        <li>    
                            ...
                            <td class="crmcell btop" colspan="5">
                                <div class="left">
                                    <asp:Button ID="btnFilter" runat="server" class="btn btn-lg btn-primary btn-block" Text="Tìm"
                                        OnClick="btnFilter_Click" OnClientClick="return CheckFormFitler();" TabIndex="23" UseSubmitBehavior="false" />
                                </div>
                                <div class="left">
                                    <asp:Button ID="btnSave" runat="server" class="btn btn-lg btn-primary btn-block" OnClientClick="return CheckFormSave();" Text="Lưu"
                                        OnClick="btnSave_Click" TabIndex="22" UseSubmitBehavior="false" />
                                </div>
                                <div class="left">
                                    <asp:Button ID="btnCancel" runat="server" class="btn btn-lg btn-primary btn-block" OnClick="btnCancel_Click" Text="Hủy"
                                         OnClientClick="return CheckFormCancel();" TabIndex="24" UseSubmitBehavior="false" />
                                </div>
                                <div class="left">
                                    <asp:Button ID="btnDelete" runat="server" class="btn btn-lg btn-primary btn-block" OnClientClick="return CheckFormDelete();" OnClick="btnDelete_Click" Text="Xóa"
            ...
            <div class="crmcontainer">
                <eoscrm:Grid ID="gvList" runat="server" UseCustomPager="true" OnRowDataBound="gvList_OnRowDataBound" 
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderStyle-Width="40px" HeaderText="Ngày đăng ký&nbsp;">
                            <ItemTemplate>
                                <%# (Eval("NGAYDK") != null) ?
