...
namespace EOSCRM.Web.Forms.GhiChiSo
{
    public partial class SuaChiSo : Authentication
    {
        ...
        public void timkv()
        {
            ...
            foreach (var a in query)
            {
                ...
                else
                {
                    ...
                    //btnSearch.Visible = !_gcsDao.IsLockTinhCuocKy1(kynay, ddlKHUVUC1.SelectedValue);
        ...
        private void BindData()
        {
            ...
            if (!_gcsDao.IsDaKhoiTao(kynay, kh.IDKH) || kh.XOABOKH == true)
            {
        ...
        private void BindDataTheoTT()
        {           
            var kynay = new DateTime(int.Parse(txtNAM.Text.Trim()), int.Parse(ddlTHANG.SelectedValue), 1);

            if (ddlPHIENLX.SelectedValue != "%")
            {
                var list = _gcsDao.GetListForUpdatePHIENLXTT(kynay, txtSODB.Text.Trim(), "", ddlDOTGCS.SelectedValue,
                        ddlPHIENLX.SelectedValue, ddlTTHAIGHIMOI.SelectedValue, ddlKHUVUC1.SelectedValue);
            ...
            {
                var list = _gcsDao.GetListForUpdateDOTINTT(kynay, txtSODB.Text.Trim(), "", ddlDOTGCS.SelectedValue,
                        ddlPHIENLX.SelectedValue, ddlTTHAIGHIMOI.SelectedValue, ddlKHUVUC1.SelectedValue);
        ...
        private void BindDataMoi()
        {
            ...
            var list = _gcsDao.GetListForUpdateMoi(kynay, txtSODB.Text.Trim(), "", ddlTTHAIGHIMOI.SelectedValue);
        ...
        protected void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            bool dung = _gcsDao.IsLockTinhCuocKy1(kynay1, ddlKHUVUC.SelectedValue, 
                !string.IsNullOrEmpty(txtSODB.Text.Trim()) ?  txtSODB.Text.Trim().Substring(0,4) : "");            
            ...
            else
            {
                ...
                {
                    if (ddlTTHAIGHIMOI.SelectedValue == "%")
                    {
                        BindData();
                    }
                    else
