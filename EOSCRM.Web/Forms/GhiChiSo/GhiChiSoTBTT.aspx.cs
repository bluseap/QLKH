...
{
    public partial class GhiChiSoTBTT : Authentication
    {
        ...
        {
            Page.Title = Resources.Message.TITLE_GCS_GHICHISOTBTT;

            var header = (Header)Master.FindControl("header");
            if (header != null)
            {
                header.ModuleName = Resources.Message.MODULE_GHICHISO;
                header.TitlePage = Resources.Message.PAGE_GCS_GHICHISOTBTT;
            }
