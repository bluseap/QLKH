...
<%@ Page Language="C#" MasterPageFile="~/Shared/EOS.Master" AutoEventWireup="true"
    CodeBehind="InHoaDon.aspx.cs" Inherits="EOSCRM.Web.Forms.GhiChiSo.InHoaDon" %>
                    ...
                    <tbody>
                        ...
                        <tr>    
                            ...
                            <td class="crmcell"> 
                                ...
                                <div class="left">
                                    <asp:Button ID="btnBaoCaoThuy" OnClick="btnBaoCaoThuy_Click" OnClientClick="return CheckFormReport();"
                            ...
                            <tr>
                                <td style="width: 5%; border: 0px;">
                                    <input id="chkDuongPho" runat="server" type="checkbox" 
                                        title='<%# Eval("MADP") %>' lang='<%# Eval("DUONGPHU") %>' />
                                </td>                                    
