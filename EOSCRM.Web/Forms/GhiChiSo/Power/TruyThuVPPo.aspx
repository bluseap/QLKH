<%@ Page Title="" Language="C#" MasterPageFile="~/Shared/PO.Master" AutoEventWireup="true" CodeBehind="TruyThuVPPo.aspx.cs" Inherits="EOSCRM.Web.Forms.GhiChiSo.Power.TruyThuVPPo" %>
                ...
                <ContentTemplate>
                    <table cellpadding="3" cellspacing="1" style="width: 610px;">
                        <tbody>
                            ...
                            <tr>
                                <td class="ptop-10" id="tdDanhSach" runat="server" >
                                                ...
                                                <asp:TemplateField HeaderStyle-Width="10%" HeaderText="Mã KH">
                                                    <ItemTemplate>
                                                        <asp:LinkButton ID="lnkBtnIDDS" runat="server" CommandName="SelectSODB" 
                                                            ...
                                                            Text='<%# Eval("MADPPO") + Eval("MADBPO").ToString() %>'></asp:LinkButton>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                ...
                <eoscrm:Grid ID="gvDieuChinhHD" runat="server" UseCustomPager="True" PageSize="20"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderStyle-Width="12%" HeaderText="Danh số">
                            <ItemTemplate>
                            <asp:LinkButton ID="lnkBtnIDDC" runat="server" CommandArgument='<%# Eval("IDKHPO") %>' 
