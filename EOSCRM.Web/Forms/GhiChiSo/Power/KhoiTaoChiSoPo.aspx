<%@ Page Title="" Language="C#" MasterPageFile="~/Shared/PO.Master" AutoEventWireup="true" CodeBehind="KhoiTaoChiSoPo.aspx.cs" Inherits="EOSCRM.Web.Forms.GhiChiSo.Power.KhoiTaoChiSoPo" %>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="crmcell">    
                                ...
                                <div class="left">
                                    <asp:Button ID="btnNguyen" runat="server" CommandArgument="Insert" CssClass="init"
                                        CausesValidation="false" UseSubmitBehavior="false" TabIndex="4" 
                                        OnClientClick="return CheckFormbtnNguyen();" OnClick="btnNguyen_Click" Visible="False" />
                                </div>
                            </td>
                        </tr>
                    </tbody>
