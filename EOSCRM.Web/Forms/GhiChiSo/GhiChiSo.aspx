...
<%@ Page Language="C#" MasterPageFile="~/Shared/EOS.Master" AutoEventWireup="True" EnableEventValidation="true"
    CodeBehind="GhiChiSo.aspx.cs" Inherits="EOSCRM.Web.Forms.GhiChiSo.GhiChiSo" %>
    ...
    <script type="text/javascript">
        ...
        function onSelectedIndexChangedEventHandler(txtCHISODAUId, txtCHISOCUOIId, txtKLTIEUTHUId, ddlTTHAIGHIId, hfGCSId, e) {
            ...
            /*if (tt != "Q") {               
                ...
                $("#" + txtCHISODAUId).attr('readonly', 'readonly');
                $("#" + txtCHISODAUId).attr('class', 'readonly');
                $("#" + txtKLTIEUTHUId).attr('readonly', 'readonly');
                $("#" + txtKLTIEUTHUId).attr('class', 'readonly');

                FocusAndSelect(txtCHISOCUOIId);
            }
            else {
                //setControlValue(txtCHISODAUId, csd);
                setControlValue(txtCHISOCUOIId, 0);
                setControlValue(txtKLTIEUTHUId, 0);

                $("#" + txtCHISODAUId).removeAttr('readonly');
                $("#" + txtCHISODAUId).attr('class', 'editable');
                $("#" + txtCHISOCUOIId).removeAttr('readonly');
                $("#" + txtCHISOCUOIId).attr('class', 'editable');
                $("#" + txtKLTIEUTHUId).removeAttr('readonly');
                $("#" + txtKLTIEUTHUId).attr('class', 'editable');
            ...
            if (code == 13) {
                if (order == 1) {
                    ...
                    if (tthaighi != "Q") {
                        ...
                        $.ajax({
                            type: "POST",
                            url: "EOSCRM.Web.Common.AjaxCRM.cs/UpdateGCS",
