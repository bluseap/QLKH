...
{
    public partial class DSChuaTCPo : Authentication
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    var dt = (DataTable)Session[SessionKey.TC_BAOCAO_CHUANTCPO];
                    Report(dt);
                }
            }
            catch (Exception ex)
        ...
        {
            Page.Title = Resources.Message.TITLE_TC_BAOCAO_DSCHUATHICONGPO;
            var header = (Header)Master.FindControl("header");
            if (header != null)
            {
                header.ModuleName = Resources.Message.MODULE_THICONG;
                header.TitlePage = Resources.Message.PAGE_TC_BAOCAOPO_DSCHUATHICONGPO;
            }
        }
        ...
        protected void btnBaoCao_Click(object sender, EventArgs e)
        {
            ...
            var ds = new ReportClass().DSQuiTrinhPoBien(TuNgay, DenNgay, cboKhuVuc.Text, "", "", "", "DSCHUATHICPO");
        ...
        private void Report(DataTable dt)
        {
            ...
            var path = Server.MapPath("~/Reports/ThiCong/DSChuaTCPo.rpt");
            rp.Load(path);
            ...
            if (txtTitle != null)
                txtTitle.Text = "DANH SÁCH CHƯA THI CÔNG ĐỒNG HỒ ĐIỆN";
            ...
            Session[SessionKey.TC_BAOCAO_CHUANTCPO] = dt;
