<%@ Page Title="" Language="C#" MasterPageFile="~/Shared/EOS.Master" AutoEventWireup="true" CodeBehind="InPhieuLapNuoc.aspx.cs" Inherits="EOSCRM.Web.Forms.ThiCongCongTrinh.InPhieuLapNuoc" %>
                    ...
                    <table class="crmtable">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="crmcell width-250">    
                                    <div class="left">
                                        <asp:TextBox ID="txtHOTENNV1" runat="server" Width="180px" MaxLength="100"  ReadOnly="true"
                                            TabIndex="1" />                            
                                    </div>
                            ...
                            <tr>    
                                ...
                                <td class="crmcell btop" colspan="3">
                                    <div class="right">
                                        <asp:LinkButton ID="linkPLDATMAU"  runat="server" 
                                            OnClientClick="return CheckFormReport();" OnClick="linkPLDATMAU_Click"  >
                                            In phiếu lắp đặt nước theo mẫu.
                                        </asp:LinkButton>
                                    </div>
                                    <div class="left">
