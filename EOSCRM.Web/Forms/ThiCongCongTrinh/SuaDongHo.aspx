<%@ Page Title="" Language="C#" MasterPageFile="~/Shared/EOS.Master" AutoEventWireup="true" CodeBehind="SuaDongHo.aspx.cs" Inherits="EOSCRM.Web.Forms.ThiCongCongTrinh.SuaDongHo" %>
            ...
            <div class="crmcontainer">
                <eoscrm:Grid ID="gvList" runat="server" AllowPaging="true" AutoGenerateColumns="false" CssClass="crmgrid"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField HeaderStyle-Width="10%" DataField="MADDK" HeaderText="Mã đơn" />                        
