...
{
    public partial class InBBNghiemThuN : Authentication
    {
        ...
        {
            Page.Title = Resources.Message.TITLE_TC_INBBNGHIEMTHUN;

            var header = (Header)Master.FindControl("header");
            if (header == null) return;

            header.ModuleName = Resources.Message.MODULE_THICONG;
            header.TitlePage = Resources.Message.PAGE_TC_INBBNGHIEMTHUN;
        ...
        protected void ReLoadBaoCao()
        {
            ...
            var path = Server.MapPath("~/Reports/KiemDinhDongHo/BBNghiemThu.rpt");
            ...
            var dkk = ddkDao.Get(txtMADDK.Text.Trim());
            var hd = _hdDao.Get(txtMADDK.Text.Trim());
            var pb = _pbDao.Get(LoginInfo.NHANVIEN.MAPB);
            var bb = _bbntDao.GetMADDK(txtMADDK.Text.Trim());
            if (bb == null)
            {
            ...
            if (txtCANCU != null)
                txtCANCU.Text = "   Căn cứ vào bảng thiết kế chiết tính vật tư ngày " + ngaytk + " của khách hàng là "
                    + dkk.TENKH + ", địa chỉ " + sn1 + ". Danh số: " + hd.MADP + hd.MADB + " thuộc HTCN: " + htcn + ".";
            ...
            TextObject txtVITRILAP = rp.ReportDefinition.ReportObjects["txtVITRILAP"] as TextObject;
            if (txtVITRILAP != null)
            ...
            if (txtLOAIDH != null)
                txtLOAIDH.Text = "Loại đồng hồ: 15mm; Hiệu: " + madh1 + "; Nước SX: TQ .";
        ...
        protected void BaoCaoBBNTTK()
        {
            ...
            rp = new ReportDocument();
            //var path = Server.MapPath("../../../Reports/QuanLyGhiDHTinhCuocInHD/DSTTBANG.rpt");
            var path = Server.MapPath("~/Reports/KiemDinhDongHo/BBNghiemThuNTK.rpt");
        ...
        protected void linkBBNTHUMAU_Click(object sender, EventArgs e)
        {
            ...
            */
            ...
            if (txtDANHSOM != null)
                txtDANHSOM.Text =  hd.MADP + hd.MADB ;
