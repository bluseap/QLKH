    ...
    public partial class CapNhatChiTietSauThiCong : Authentication
    {
        ...
        private THICONG ThiCong
        {
            get
            {
                ...
                //objUi.NGAYBD = DateTimeUtil.GetVietNamDate(txtNgayCapNhat.Text.Trim());// NGAY CAP NHAT TC
                objUi.NGAYBD = DateTime.Now;// NGAY CAP NHAT TC
                ...
                objUi.HDKEMTHEO = ddlXDHDKEMTHEO.SelectedValue;
                objUi.NGAYN = DateTime.Now;
        ...
        private void BindDataForGrid()
        {
            try
            {
                ...
                if (Filtered == FilteredMode.None)
                {
                    ...
                    var objList = tcdao.GetListDangThiCong2(ddlMaKV.SelectedValue);
        ...
        private void ClearContent()
        {
            ...
            ddlXDHDKEMTHEO.SelectedIndex = 0;
        }   
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            if (string.IsNullOrEmpty(txtMaDH.Text.Trim()) || txtMaDH.Text.Trim() == "")
            {
                ShowError("Kiểm tra số No đồng hồ..");
                CloseWaitingDialog();
                return;                
            }
            ...
            var khm = _khDao.GetMADDK(thicong.MADDK);
            ...
            if (string.IsNullOrEmpty(lbMADDTRAHSTK.Text.Trim()) || lbMADDTRAHSTK.Text == "")
            {
                ...
                {
                    msg = tcdao.Update2(thicong, TTTC.TC_A, CommonFunc.GetComputerName(), CommonFunc.GetLanIPAddressM(), LoginInfo.MANV);
            ...
            //dhDao.UpdateDASDMoi(txtMaDH.Text.Trim());
        ...
        private void BindTCToForm(THICONG obj)
        {
            ...
            txtNgayHoanThanh.Text = obj.NGAYHT.HasValue ? obj.NGAYHT.Value.ToString("dd/MM/yyyy") : DateTime.Now.ToString("dd/MM/yyyy");
            txtNgayCapNhat.Text = obj.NGAYBD.HasValue ? obj.NGAYBD.Value.ToString("dd/MM/yyyy") : DateTime.Now.ToString("dd/MM/yyyy");
            ...
            if (obj.HDKEMTHEO != null)
            {
                var hdkt = ddlXDHDKEMTHEO.Items.FindByValue(obj.HDKEMTHEO);
                if (hdkt != null)
                    ddlXDHDKEMTHEO.SelectedIndex = ddlXDHDKEMTHEO.Items.IndexOf(hdkt);
            }

            txtCKDM1.Text = obj.CHIKDM1 != null ?  obj.CHIKDM1 : "";
            txtCKDM2.Text = obj.CHIKDM2 != null ? obj.CHIKDM2 : "";
                ...
                switch (e.CommandName)
                {
                    ...
                    case "SuaMaChiKD":
                        ...
                        if (ttnt.Equals("NT_A"))
                        {
                            ...
                            ShowInFor("Khách hàng đã nghiệm thu.");                                             
                        }
                        else
                        {
        ...
        private void BindNhanVien()
        {
            ...
            //var list = nvdao.SearchKV(txtKeywordNV.Text.Trim(), nvdao.Get(b).MAKV, "");
        ...
        private void BindToInfor(string id)
        {
            try
            {
                ...
                txtDUONG.Text = obj.MADP != null ? _dpDao.GetDP(obj.MADP.ToString()).TENDP : "";
                txtPHUONG.Text = obj.MAPHUONG != null ? _pDao.GetMAKV(obj.MAPHUONG,obj.MAKV).TENPHUONG : "";
        ...
        private void BindDDK()
        {
            try
            {
                ...
                {
                    var list = ddkDao.GetListDonThiCongCD(txtFilter.Text.Trim(), tungay, denngay, ddlMaKV.SelectedValue);
