...
{
    public partial class DSChuaTC : Authentication
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    var dt = (DataTable)Session[SessionKey.TC_BAOCAO_CHUANTCN];
                    Report(dt);
                }
            }
            catch (Exception ex)
        ...
        {
            Page.Title = Resources.Message.TITLE_TC_BAOCAO_DSCHUATHICONG;
            var header = (Header)Master.FindControl("header");
            if (header != null)
            {
                header.ModuleName = Resources.Message.MODULE_THICONG;
                header.TitlePage = Resources.Message.PAGE_TC_BAOCAO_DSCHUATHICONG;
            }
        }
        ...
        protected void btnBaoCao_Click(object sender, EventArgs e)
        {
            ...
            var ds = new ReportClass().DSQuiTrinhNuocBien(TuNgay, DenNgay, cboKhuVuc.Text, "", "", "", "DSCHUATHICN");
        ...
        private void Report(DataTable dt)
        {
            ...
            var path = Server.MapPath("~/Reports/ThiCong/DSChuaTCN.rpt");
            rp.Load(path);
            ...
            if (txtTitle != null)
                txtTitle.Text = "DANH SÁCH CHƯA THI CÔNG ĐỒNG HỒ NƯỚC";
            ...
            Session[SessionKey.TC_BAOCAO_CHUANTCN] = dt;
