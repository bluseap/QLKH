<%@ Page Language="C#" MasterPageFile="~/Shared/EOS.master" AutoEventWireup="True"
    Inherits="EOSCRM.Web.Forms.DanhMuc.CongViec" CodeBehind="CongViec.aspx.cs" %>
        ...
        <ContentTemplate>
            <div class="crmcontainer">
                <table class="crmtable">
                    <tbody>
                        <tr>    
                            <td class="crmcell right">Mã công việc</td>
                            <td class="crmcell"> 
                                <div class="left">
                                    <asp:TextBox ID="txtMACV" runat="server" Width="50px" MaxLength="10" TabIndex="1" />
                                </div>
                                <div class="left filtered"></div>
                                <div class="left width-175">
                                    <div class="right">Tên công việc</div>
                                </div>
                                <div class="left">
                                    <asp:TextBox ID="txtTENCV" runat="server" Width="250px" MaxLength="50" TabIndex="1" />
                                </div>
                                <div class="left filtered"></div>
                            </td>
                        </tr>
        ...
        <ContentTemplate>
            <div class="crmcontainer">
                <eoscrm:Grid ID="gvList" runat="server" UseCustomPager="true" OnRowDataBound="gvList_RowDataBound" 
                    ...
                    <PagerSettings FirstPageText="công việc" PageButtonCount="2" />
                    <Columns>
                        <asp:TemplateField HeaderStyle-CssClass="checkbox">
                            ...
                            <ItemTemplate>
                                <input id="Id" runat="server" type="hidden" value='<%# Eval("MACV") %>' />
                                <input name="listIds" type="checkbox" value='<%# Eval("MACV") %>' />
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Mã công việc" HeaderStyle-Width="20%">
                            <ItemTemplate>
                                <asp:LinkButton ID="lnkBtnID" runat="server" CommandArgument='<%# Eval("MACV") %>'
                                    CommandName="EditItem" Text='<%# Eval("MACV") %>'></asp:LinkButton>
                            </ItemTemplate>
                            <ItemStyle Font-Bold="True" />
                        </asp:TemplateField>
                        <asp:BoundField HeaderStyle-Width="78%" DataField="TENCV" HeaderText="Tên công việc" />
                    </Columns>
                </eoscrm:Grid>        
            </div>
        </ContentTemplate>
