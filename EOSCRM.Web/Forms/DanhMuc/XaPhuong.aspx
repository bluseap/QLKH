<%@ Page Title="" Language="C#" MasterPageFile="~/Shared/EOS.Master" AutoEventWireup="true" CodeBehind="XaPhuong.aspx.cs" Inherits="EOSCRM.Web.Forms.DanhMuc.XaPhuong" %>
        ...
        <ContentTemplate>
            <div class="crmcontainer">
                <table class="crmtable">
                    <tbody>
                        <tr>    
                            <td class="crmcell right">Mã xã, phường</td>
                            <td class="crmcell"> 
                                <div class="left">
                                    <asp:TextBox ID="txtMaXaPhuong" runat="server" Width="100px" MaxLength="4" TabIndex="1" />
                                </div>
                        ...
                        <tr>    
                            <td class="crmcell right">Tên xã, phường</td>
                            <td class="crmcell"> 
                                <div class="left">
                ...
                <eoscrm:Grid ID="gvList" runat="server" UseCustomPager="true" OnRowCommand="gvList_RowCommand"
                    ...
                    <Columns>
                        <asp:TemplateField HeaderStyle-CssClass="checkbox">
                            ...
                            <ItemTemplate>
                                <input id="Id" runat="server" type="hidden" value='<%# Eval("MAXA").ToString()%>' />
                                <input name="listIds" type="checkbox" value='<%# Eval("MAXA").ToString() %>' />
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Mã phường" HeaderStyle-Width="18%">
                            <ItemTemplate>
                                <asp:LinkButton ID="lnkBtnID" runat="server" CommandArgument='<%# Eval("MAXA").ToString()  %>'
                                    CommandName="EditItem" Text='<%# Eval("MAXA").ToString() %>'></asp:LinkButton>
                            </ItemTemplate>
                            <ItemStyle Font-Bold="True" />
                        </asp:TemplateField>
                        <asp:BoundField HeaderText="Tên xã, phường" DataField="TENXA" HeaderStyle-Width="40%" />                        
