    ...
    public partial class Phuong : Authentication
    {
        ...
        private void BindDataForGrid()
        {
            if (Filtered == FilteredMode.None)
            {
                ...
                var objList = _objDao.GetListKV(cboKhuVuc.SelectedValue);
            ...
            else
            {
                ...
                var objList = _objDao.GetListKVM(cboKhuVuc.SelectedValue);
            ...
            try
            {
                ...
                switch (e.CommandName)
                {
                    case "EditItem":
                        ...
                        {
                            var objDb = _objDao.GetMAKV(maphuong, cboKhuVuc.SelectedValue);
                            if (objDb != null)
                            {
                                BindItem(objDb);
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                msg = _objDao.Update(info, cboKhuVuc.SelectedValue);
            }
