<%@ Page Language="C#" MasterPageFile="~/Shared/EOS.master" AutoEventWireup="True"
    Inherits="EOSCRM.Web.Forms.DanhMuc.NhomPhanHoi" CodeBehind="NhomPhanHoi.aspx.cs" %>
        ...
        <ContentTemplate>
            <div class="crmcontainer">
                <table class="crmtable">
                    <tbody>
                        <tr>    
                            <td class="crmcell right">Mã nhóm</td>
                            <td class="crmcell"> 
                                <div class="left">
                                    <asp:TextBox ID="txtMANHOM" runat="server" Width="50px" MaxLength="10" TabIndex="1" />
                                </div>
                                <div class="left width-175">
                                    <div class="right">Tên nhóm</div>
                                </div>
                                <div class="left">
                                    <asp:TextBox ID="txtTENNHOM" runat="server" Width="250px" MaxLength="50" TabIndex="1" />
                                </div>
                            </td>
                        </tr>
                        <tr>    
        ...
        <ContentTemplate>
            <div class="crmcontainer">
                <eoscrm:Grid ID="gvList" runat="server" UseCustomPager="true" OnRowDataBound="gvList_RowDataBound" 
                    ...
                    <PagerSettings FirstPageText="nhóm phản hồi" PageButtonCount="2" />
                    <Columns>
                       <asp:TemplateField HeaderStyle-CssClass="checkbox">
                            ...
                            <ItemTemplate>
                                <input id="Id" runat="server" type="hidden" value='<%# Eval("MANHOM") %>' />
                                <input name="listIds" type="checkbox" value='<%# Eval("MANHOM") %>' />
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Mã nhóm" HeaderStyle-Width="20%">
                            <ItemTemplate>
                                <asp:LinkButton ID="lnkBtnID" runat="server" CommandArgument='<%# Eval("MANHOM") %>'
                                    CommandName="EditItem" Text='<%# Eval("MANHOM") %>'></asp:LinkButton>
                            </ItemTemplate>
                            <ItemStyle Font-Bold="True" />
                        </asp:TemplateField>
                        <asp:BoundField HeaderStyle-Width="78%" DataField="TENNHOM" HeaderText="Tên nhóm" />
                    </Columns>
                </eoscrm:Grid>        
            </div>
        </ContentTemplate>
