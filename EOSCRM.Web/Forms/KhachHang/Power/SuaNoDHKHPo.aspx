<%@ Page Title="" Language="C#" MasterPageFile="~/Shared/PO.Master" AutoEventWireup="true" CodeBehind="SuaNoDHKHPo.aspx.cs" Inherits="EOSCRM.Web.Forms.KhachHang.Power.SuaNoDHKHPo" %>
                    ...
                    <Columns>                    
                        ...
                        <asp:TemplateField HeaderText="Danh số " HeaderStyle-Width="80px">
                            ...
                            <asp:LinkButton ID="lkIDSONO" runat="server" CommandArgument='<%# Eval("IDSONO") %>'
                                CommandName="EditItem" CssClass="link" Text='<%# HttpUtility.HtmlEncode(Eval("MADPPO").ToString()+Eval("MADBPO")) %>'></asp:LinkButton>
                            </ItemTemplate>
