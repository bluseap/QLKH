<%@ Page Title="" Language="C#" MasterPageFile="~/Shared/PO.Master" AutoEventWireup="true" CodeBehind="ThayHopDongPo.aspx.cs" Inherits="EOSCRM.Web.Forms.KhachHang.Power.ThayHopDongPo" %>
                                                ...
                                                <asp:TemplateField HeaderStyle-Width="10%" HeaderText="Mã KH">
                                                    <ItemTemplate>
                                                        <asp:LinkButton ID="lnkBtnID" runat="server" CommandName="SelectSODB" 
                                                            ...
                                                            Text='<%# Eval("MADPPO").ToString() + Eval("MADBPO") %>'></asp:LinkButton>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                ...
                <eoscrm:Grid 
                    ...
                    <Columns>                    
                        ...
                        <asp:TemplateField HeaderText="Mã " HeaderStyle-Width="75px">
                            <ItemTemplate>
                            <asp:LinkButton ID="lnkBtnIDTHD" runat="server" CommandArgument='<%# Eval("IDTHDPO") %>'
                                CommandName="EditItem" CssClass="link" Text='<%# HttpUtility.HtmlEncode(Eval("MADPPO").ToString()+Eval("MADBPO").ToString()) %>'></asp:LinkButton>
                            </ItemTemplate>
