            ...
            <eoscrm:Grid ID="gvList" runat="server" 
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderStyle-Width="40px" HeaderText="Mã đường">
                        <ItemTemplate>
                            <asp:TextBox ID="txtMADPG" runat="server" MaxLength="4" Text='<%# Bind("MADP") %>' 
                                Width="70px" />
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderStyle-Width="40px" HeaderText="Danh số">
                        <ItemTemplate>
                            <asp:TextBox ID="txtMADBG" runat="server" MaxLength="4" Text='<%# Bind("MADB") %>' 
                                Width="90px" />
                        </ItemTemplate>
                    </asp:TemplateField>
