<%@ Page Language="C#" MasterPageFile="~/Shared/EOS.Master" AutoEventWireup="true" 
    CodeBehind="InHopDongKH.aspx.cs" Inherits="EOSCRM.Web.Forms.KhachHang.InHopDongKH" %>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="crmcell left">
                                    <div class="right">
                                        <asp:LinkButton ID="linkHD"  runat="server" onclick="linkHD_Click" 
                                            OnClientClick="return CheckFormReport();" >
                                            In hợp đồng giấy trắng.
                                        </asp:LinkButton>
                                    </div>
                                    <div class="left">
