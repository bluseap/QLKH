<%@ Page Title="" Language="C#" MasterPageFile="~/Shared/EOS.Master" AutoEventWireup="true" CodeBehind="GiaHanHopDong.aspx.cs" Inherits="EOSCRM.Web.Forms.KhachHang.GiaHanHopDong" %>
                ...
                <table class="crmtable">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                               <div class="left">
                                    <asp:Label ID="lbGHICHU" runat="server" Text="Chỉ in lại hợp đồng khách hàng" Font-Bold="True" Font-Size="Large" ForeColor="#FF3300"></asp:Label>
                                </div>
                             </td>
                        </tr>
                        <tr>
