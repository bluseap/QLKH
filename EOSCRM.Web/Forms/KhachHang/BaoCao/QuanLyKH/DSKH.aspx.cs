...
{
    public partial class Dskh : Authentication
    {
        ...
        {
            Page.Title = Resources.Message.TITLE_KH_BAOCAO_QLKH_DANHSACHKH;

            var header = (Header)Master.FindControl("header");
            if (header != null)
            {
                header.ModuleName = Resources.Message.MODULE_KHACHHANG;
                header.TitlePage = Resources.Message.PAGE_KH_BAOCAO_QLKH_DANHSACHKH;
            }
...
// ReSharper restore EmptyGeneralCatchClause
            ...
            var dt =
                new ReportClass().DSKHTS(txtMaDp.Text.Trim(), txtDuongPhu.Text.Trim(), cboMucDichSuDung.Text.Trim(),
                                       cboTrangThai.Text.Trim(), cboKhuVuc.Text.Trim(), chkLocHaiGia.Checked, 
                                       int.Parse(ddlTHANG.SelectedValue), int.Parse(txtNAM.Text.Trim())).Tables[0];
            ...
            txtTIEUDE1.Text = "DANH SÁCH KHÁCH HÀNG KỲ " + int.Parse(ddlTHANG.SelectedValue) + " / " + int.Parse(txtNAM.Text.Trim());
...
// ReSharper restore EmptyGeneralCatchClause
        ...
        protected void txtDuongPhu_TextChanged(object sender, EventArgs e)
        {

        }

        protected void txtMaDp_TextChanged(object sender, EventArgs e)
        {

        }

        protected void cboMucDichSuDung_SelectedIndexChanged(object sender, EventArgs e)
        {
