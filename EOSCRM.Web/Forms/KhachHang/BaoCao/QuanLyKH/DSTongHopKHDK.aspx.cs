    ...
    public partial class DSTongHopKHDK : Authentication
    {
        ...
        private void LoadReferences()
        {
            try
            {
                ...
                ddlDieuKien.Items.Add(new ListItem("DS đã duyệt chiết tính nhưng chưa thi công (Toàn bộ)", "DSDuyetCTKoThiCong"));
        ...
        protected void btDSDieuKien_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (ddlDieuKien.SelectedValue != "%")
                {
                    ...
                    else if (ddlDieuKien.SelectedValue == "DSNTKOKHM") // nhap nghiem thu chua khai thac moi
                    {
                        var ds = new ReportClass().DSTongHopDDK(tungay, denngay, cboKhuVuc.SelectedValue, ddlNHAMAYTO.SelectedValue,
                    ...
                    //DSDuyetCTKoThiCong
                    else if (ddlDieuKien.SelectedValue == "DSDuyetCTKoThiCong")
                    {
                        var ds = new ReportClass().Get_DSTongHopKHDK_ByDuyetCTKoTC(cboKhuVuc.SelectedValue, ddlNHAMAYTO.SelectedValue, tungay, denngay);
                        dt = ds.Tables[0];
                    }
                    else
                    {
