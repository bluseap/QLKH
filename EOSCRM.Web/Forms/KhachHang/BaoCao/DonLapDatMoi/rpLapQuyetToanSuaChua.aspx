<%@ Page Language="C#" MasterPageFile="~/Shared/EOS.Master" AutoEventWireup="true" 
    CodeBehind="rpLapQuyetToanSuaChua.aspx.cs" Inherits="EOSCRM.Web.Forms.KhachHang.BaoCao.DonLapDatMoi.rpLapQuyetToanSuaChua" %>
        ...
        <tbody>
            <tr>
                ...
                <td class="crmcell" style="width: 204px">
                    <div class="left">
                        <asp:TextBox ID="txtKHKT" runat="server" Width="200px" Text = "Lê Thanh Nhu" />
                    </div>
                </td>
            </tr>
            <tr>
                ...
                <td class="crmcell" colspan="3">
                    <div class="left">
                        <asp:TextBox ID="txtGiamDoc" runat="server" Width="200px" Text = "Trịnh Thành Nghiêm" />
                    </div>
                </td>
            </tr>
            <tr>
