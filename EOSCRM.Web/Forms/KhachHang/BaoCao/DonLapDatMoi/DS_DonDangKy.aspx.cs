...
{
    public partial class DS_DonDangKy : Authentication
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    if (Session[SessionKey.TK_BAOCAO_COBIEN] == "DONDANGKY")
                    {
        ...
        {
            Page.Title = Resources.Message.TITLE_KH_BAOCAO_DLM_DONDANGKY;

            var header = (Header)Master.FindControl("header");
            if (header != null)
            {
                header.ModuleName = Resources.Message.MODULE_KHACHHANG;
                header.TitlePage = Resources.Message.PAGE_KH_BAOCAO_DLM_DONDANGKY;
            }
        }
        ...
        protected void listPhongBan()
        {
            ...
            foreach (var a in query)
            {
                ...
                if (a.MAKV == "U" || a.MAKV == "S" || a.MAKV == "P" || a.MAKV == "T" || a.MAKV == "K"//thoaison,chau doc,phu tan,tan chau,chomoi
                    || a.MAKV == "L" || a.MAKV == "M" || a.MAKV == "Q" //tri ton,tinhbien,anphu
                    )
                {
                    ddlPHONGBAN.Items.Clear();
                    if (a.MAPB == "KD")
        ...
        protected void btnBaoCao_Click(object sender, EventArgs e)
        {
            ...
            if (query.MAKV != "O")
            {
                ...
                var ds = new ReportClass().RpdscdDangKyPBNgayN(TuNgay, DenNgay, cboKhuVuc.Text, ddlPHONGBAN.SelectedValue);
            ...
            else// chau thanh lay ngay dang ky tren don
            {
                ...
                Session[SessionKey.TK_BAOCAO_COBIEN] = "DONDANGKY";
            }            
        ...
        protected void btExcelDSDLM_Click(object sender, EventArgs e)
        {
            try
            {
                var loginInfo = Session[SessionKey.USER_LOGIN] as UserAdmin;
                ...
                var ds = new ReportClass().DSQuiTrinhNuocBien(TuNgay, DenNgay, cboKhuVuc.Text, ddlPHONGBAN.SelectedValue, "", "",
                        "DSDLMNCDNGAYN");
                ...
                Response.AddHeader("content-disposition", "attachment;filename=DLMN" + TuNgay.Month.ToString() + TuNgay.Year.ToString().Substring(2, 2) + ".xls");
                Response.Charset = "";
        ...
        /*protected void printreport_Click(object sender, EventArgs e)
        {
            ...
            rv1.LocalReport.ReportPath = Server.MapPath("~/Reports/DonLapDatMoi/DSDonDangKy.rdlc");
            //Customers dsCustomers = GetData();
            var TuNgay = DateTimeUtil.GetVietNamDate(txtTuNgay.Text.Trim());
            var DenNgay = DateTimeUtil.GetVietNamDate(txtDenNgay.Text.Trim());
            var ds = new ReportClass().RpdscdDangKyPB(TuNgay, DenNgay, cboKhuVuc.Text, ddlPHONGBAN.SelectedValue);

            ReportDataSource datasource = new ReportDataSource("Customers", ds.Tables[0]);
