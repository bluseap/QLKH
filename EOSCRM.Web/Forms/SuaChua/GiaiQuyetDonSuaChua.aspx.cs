...
{
    public partial class GiaiQuyetDonSuaChua : Authentication
    {
        ...
        {
            Page.Title = Resources.Message.TITLE_SC_GIAIQUYETDONSUACHUA;

            var header = (Header)Master.FindControl("header");
            if (header != null)
            {
                header.ModuleName = Resources.Message.MODULE_SUACHUA;
                header.TitlePage = Resources.Message.PAGE_SC_GIAIQUYETDONSUACHUA;
            }
