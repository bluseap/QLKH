...
{
    public partial class LapQuyetToanSuaChua : Authentication
    {
        ...
        protected QUYETTOANSUACHUA ChietTinh
        {
            get
            {
                try { return qtscdao.Get(MADON); }
                catch { return null; }
            }
        }
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (!Page.IsPostBack)
                {
                    ...
                    {
                        var ct =qtscdao.Get(Session["LAPCHIETTINHSUACHUA_MADDK"].ToString());
                        if (ct == null)
                            return;
        ...
        protected void LapQuyetToan(QUYETTOANSUACHUA qtsc,NHANVIEN nhanvien)
        {
            BindSelectedVatTuGrid();
            BindSelectedVatTu117Grid();
            divGridList.Visible = false;
            ...
            ShowThongTinHeSoChietTinh(qtsc);
            upnlTongHopChiPhi.Visible = true;
            upnlTongHopChiPhi.Update();
            qtsc.NGAYLQT = DateTime.Now as DateTime?;
            qtscdao.Update(qtsc);
            ...
            try
            {
                ...
                switch (e.CommandName)
                {
                    case "EditItem":
                        ...
                        MADON = id;
                        var ddk = qtscdao.Get(MADON);
                        if (ddk == null)
                        {
                            CloseWaitingDialog();
                            return;
                        }
                        LapQuyetToan(ddk, nhanvien);
        ...
        //private void ChayChietTinh2(QUYETTOANSUACHUA qtsc, NHANVIEN nv)
        //{
        //    var ct = ctDao.Get(qtsc.MADON);
        //    if (ct == null)
        //    {
        ...
        private void ShowThongTinHeSoChietTinh(QUYETTOANSUACHUA chiettinh)
        {
        ...
        private void BindDataForGrid()
        {
            try
            {
                var objList = qtscdao.GetListForChoLapQuyetToan(Keyword, FromDate, ToDate);
        ...
        protected void btnCapNhatGiaTri_Click(object sender, EventArgs e)
        {
            ...
            var chiettinhtontai = qtscdao.Get(objUi.MADON);
        ...
        private void BindSelectedVatTuGrid()
        {
            ...
            var list = ctqtscdao.GetList(MADON);
        ...
        protected void gvSelectedVatTu_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            var source = gvSelectedVatTu.DataSource as List<CTQUYETTOANSUACHUA>;
            ...
            var script = "javascript:UpdateCTQTSC(\"" + maddk + "\", \"" + mavt +
                                                        "\", \"" + txtSL.ClientID +
                                                        "\", \"" + txtGIAVT.ClientID +
                                                        "\", \"" + lblTIENVT.ClientID +
                                                        "\", \"" + txtGIANC.ClientID +
        ...
        */
        private void BindSelectedVatTu117Grid()
        {
            ...
            var list = ctqtscnd117dao.GetList(MADON);
        ...
        protected void gvSelectedVatTu117_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            switch (e.CommandName)
            {
                case "DeleteVatTu":
                    ...
                    var deletingCTQT = ctqtscnd117dao.Get(ChietTinh.MADON, mavt);
                    ...
                    ctqtscnd117dao.Delete(deletingCTQT);
        ...
        protected void gvSelectedVatTu117_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            var source = gvSelectedVatTu117.DataSource as List<CTQUYETTOANSUACHUA_ND117>;
            if (source == null) return;
            ...
            var script = "javascript:UpdateCTQTSC117(\"" + maddk + "\", \"" + mavt +
                                                        "\", \"" + txtSL.ClientID +
                                                        "\", \"" + txtGIAVT.ClientID +
                                                        "\", \"" + lblTIENVT.ClientID +
                                                        "\", \"" + txtGIANC.ClientID +
