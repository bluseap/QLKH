...
{
    public partial class TietKiemCD : Authentication
    {
        ...
        private void BindDataForGrid()
        {
            ...
            {
                var objList = _nvvDao.GetList(txtMANV.Text.Trim(), txtHOTEN.Text.Trim(), ddlKHUVUC.SelectedValue, ddlPHONGBAN.SelectedValue, ddlCONGVIEC.SelectedValue);
        ...
        private void BindItem(NVVAYCD obj)
        {
            ...
            lbTONGTIENDONG.Text = _ktkDao.GetSumTien(obj.MANVV).ToString();
            lbTONGTHU.Text = _ktkDao.GetSumTienThu(obj.MANVV).ToString();
