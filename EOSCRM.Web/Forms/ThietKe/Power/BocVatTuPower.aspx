<%@ Page Title="" Language="C#" MasterPageFile="~/Shared/PO.Master" AutoEventWireup="true" CodeBehind="BocVatTuPower.aspx.cs" Inherits="EOSCRM.Web.Forms.ThietKe.Power.BocVatTuPower" %>
...
<asp:Content ID="content" ContentPlaceHolderID="ContentPlaceHolderMain" runat="server">
        ...
        <table class="crmtable">
            <tbody>
                <tr>
                    ...
                    <td class="crmcell">
                        <div class="left">
                            <%= ThietKePo != null ? ThietKePo.MADDKPO : "" %>
                        </div>
                ...
                <tr>
                    ...
                    <td class="crmcell">
                        <div class="left">
                            <%= ThietKePo != null ? ThietKePo.TENTK : "" %>
                        </div>
                    </td>
                </tr>
                <tr>
                    ...
                    <td class="crmcell">
                        <div class="left">                            
                            <%= ThietKePo != null && ThietKePo.DONDANGKYPO != null ? ThietKePo.DONDANGKYPO.DIACHILD : "" %>
                        </div>
                    </td>
                </tr>
                <tr>
                    ...
                    <td class="crmcell">
                        <div class="left">
                            <%= ThietKePo != null ? ThietKePo.CHUTHICH: "" %>
                        </div>
                    </td>
                </tr>
                <tr>
                                            ...
                                            <asp:TemplateField HeaderText="Mã VT K.Toán" HeaderStyle-Width="90px">
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="lnkBtnID" runat="server" CommandArgument='<%# Eval("MAVT") %>'  CommandName="EditItem" 
                                                        Text='<%# Eval("KeToanMaSoVatTu") != null ?  Eval("KeToanMaSoVatTu").ToString() : "" %>'></asp:LinkButton>
                                                </ItemTemplate>
                                            </asp:TemplateField>
    ...
    <asp:UpdatePanel ID="upnlMBVT" UpdateMode="Conditional" runat="server">
            ...
            <table class="crmcontainer">
                    ...
                    <td>
		               <table class="crmtable">
		                    <tr>
                                ...
                                <td class="crmcell">
		                            <div class="left">
		                                <asp:TextBox ID="txtTENKHBP"  Width="150px" runat="server" />
		                            </div>
                                    <td class="crmcell right">Danh số KH bên phải</td>                                
                                    <td class="crmcell" >   
                                        <div class="left">
                    ...
                    <td>
		               <table class="crmtable">
		                    <tr>
                                ...
                                <td class="crmcell">
		                            <div class="left">
		                                <asp:TextBox ID="txtTENKHBT" Width="150px" runat="server" />
		                            </div>
                                    <td class="crmcell right">Danh số KH bên trái</td>                                
                                    <td class="crmcell" >   
                                        <div class="left">
                                            <asp:TextBox ID="txtDANHSOBT" runat="server" Width="80px" Text = "" OnTextChanged="txtDANHSOBT_TextChanged" />
                                        </div> 
                                    </td>                     
                                </td>                                
                            </tr>
                ...
                <tr>
                    <td>
		               <table class="crmtable">
		                    <tr>
                                <td class="crmcell right">Kéo chuyển từ trụ potelet phía trước tên</td>
                                <td class="crmcell">
		                            <div class="left">
		                                <asp:TextBox ID="txtTRUTRUOC"  
		                                    Width="150px" runat="server" OnTextChanged="txtTRUTRUOC_TextChanged" />
		                            </div>
                                    <td class="crmcell right">Danh số</td>                                
                                    <td class="crmcell" >                                      
                                        <div class="left">
                                            <asp:TextBox ID="txtDSTRUTRUOC" runat="server" Width="80px" Text = "" />
                                        </div>
                                    </td>                       
                                </td>                                
                            </tr>
                ...
                <tr>
                    <td>
		               <table class="crmtable">
		                    <tr>
                                <td class="crmcell right">Kéo chuyển từ trụ potelet phía sau tên</td>
                                <td class="crmcell">
		                            <div class="left">
		                                <asp:TextBox ID="txtTRUSAU"  
		                                    Width="150px" runat="server" />
		                            </div>
                                    <td class="crmcell right">Danh số</td>                                
                                    <td class="crmcell" >                                         
                                        <div class="left">
                                            <asp:TextBox ID="txtDSTRUSAU" runat="server" Width="80px" Text = "" />
                                        </div>
                                    </td>                    
                                </td>                                
                            </tr>
                ...
                <tr>
                     <td>
		               <table class="crmtable">
		                    <tr>
                                <td class="crmcell right">Hình thiết kế </td>
                                <td class="crmcell">                                 
                                    <asp:FileUpload ID="UpHinhTK" runat="server" type="file" onchange="file_change(this)" Width="90px" />
                                ...
                                <td class="crmcell">
                                    <div class="left">
                                        <asp:DropDownList ID="ddlMBTHIETKE" runat="server" AutoPostBack="True" OnSelectedIndexChanged="ddlMBTHIETKE_SelectedIndexChanged1"       >
                                        </asp:DropDownList>
                                    </div>                                                                                           
                                </td>
                            </tr>
                ...
                <tr>
                    <td>
		               <table class="crmtable">
		                    <tr>
                                <td class="crmcell right">Kết luận sau thiết kế</td>
                                <td class="crmcell">
		                            <div class="left">
		                                <asp:TextBox ID="txtKetLuanSauTK" 	runat="server" Width="300px" />
		                            </div>                                                      
                                </td>                                
                            </tr>
                        </table>
                     ...
                     <td>
		               <table class="crmtable">
		                    <tr>
                                ...
                                <td class="crmcell">
                                    <div class="left">
                                        <asp:Button ID="btSaveMauTK" runat="server" CommandArgument="Change" CssClass="myButton" Text="Lưu thiết kế"
                                            TabIndex="16" UseSubmitBehavior="false" OnClick="btSaveMauTK_Click" />
                                    </div>
                                </td>
                            </tr>
                        </table>
                                    ...
                                    <asp:TemplateField HeaderText="Loại chi phí" HeaderStyle-Width="70px">
                                        <ItemTemplate>
                                            <asp:DropDownList ID="ddlLOAICP" runat="server" SelectedValue='<%# Bind("LOAICP") %>'
                                                ...
                                                <asp:ListItem Value="LAPD">Lắp điện</asp:ListItem>
                                                <asp:ListItem Value="THAOD">Tháo, gỡ điện</asp:ListItem>
        ...
        <Triggers>
            <asp:PostBackTrigger ControlID="btSaveMauTK" />            
        </Triggers> 
	</asp:UpdatePanel>
