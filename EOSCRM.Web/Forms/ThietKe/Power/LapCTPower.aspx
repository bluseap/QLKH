<%@ Page Title="" Language="C#" MasterPageFile="~/Shared/PO.Master" AutoEventWireup="true" CodeBehind="LapCTPower.aspx.cs" Inherits="EOSCRM.Web.Forms.ThietKe.Power.LapCTPower" %>
...
<asp:Content ID="content" ContentPlaceHolderID="ContentPlaceHolderMain" runat="server">
        ...
        <eoscrm:Grid ID="gvList" runat="server" UseCustomPager="true" OnRowDataBound="gvList_RowDataBound"
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="Hoạt động" HeaderStyle-Width="80px">
                    <ItemTemplate>
                        <asp:LinkButton ID="lnkBtnID2" runat="server" CommandArgument='<%# Eval("MADDKPO") %>'
	...
	<div class="crmcontainer p-5">
        <a href="/Forms/ThietKe/Power/DuyetCTPower.aspx">Chuyển sang bước kế tiếp</a>
    </div>
</asp:Content>
