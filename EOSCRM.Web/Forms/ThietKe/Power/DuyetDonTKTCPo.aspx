<%@ Page Title="" Language="C#" MasterPageFile="~/Shared/PO.Master" AutoEventWireup="true" CodeBehind="DuyetDonTKTCPo.aspx.cs" Inherits="EOSCRM.Web.Forms.ThietKe.Power.DuyetDonTKTCPo" %>
                                        ...
                                        <tr>
                                            ...
                                            <td class="crmcell">
                                                <div class="left">
                                                    ...
                                                    <asp:Label ID="lbMADDKMOI" runat="server" Visible="false"></asp:Label>
                                                </div>                                               
                                            </td>
                                        </tr>                                        
                                    </tbody>
						...
						<tr>
							<td class="ptop-10">
							    <div class="crmcontainer">
							        <eoscrm:Grid ID="gvTKVT" runat="server" UseCustomPager="true" OnPageIndexChanging="gvTKVT_PageIndexChanging">	
