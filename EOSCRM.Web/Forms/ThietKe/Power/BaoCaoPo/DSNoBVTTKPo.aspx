<%@ Page Title="" Language="C#" MasterPageFile="~/Shared/PO.Master" AutoEventWireup="true" CodeBehind="DSNoBVTTKPo.aspx.cs" Inherits="EOSCRM.Web.Forms.ThietKe.Power.BaoCaoPo.DSNoBVTTKPo" %>
...
<asp:Content ID="head" ContentPlaceHolderID="headCPH" runat="server">
    <script type="text/javascript">
        ...
        function CheckFormbtBVTKoDuyet() {
            openWaitingDialog();
            unblockWaitingDialog();
            __doPostBack('<%= CommonFunc.UniqueIDWithDollars(btBVTKoDuyet) %>', '');
        }
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="crmcell">    
                        ...
                        <div class="left">
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <asp:Button ID="btBVTKoDuyet" OnClientClick="return CheckFormbtBVTKoDuyet();" runat="server" CssClass="myButton" Text="BC BVT chưa duyệt TK"  />
                        </div>
                        <div class="left">
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
