<%@ Page Title="" Language="C#" MasterPageFile="~/Shared/PO.Master" AutoEventWireup="true" CodeBehind="DotInHDPo.aspx.cs" Inherits="EOSCRM.Web.Forms.GhiChiSo.Power.DotInHDPo" %>
...
<asp:Content ID="head" ContentPlaceHolderID="headCPH" runat="server">
    <script type="text/javascript">
        ...
        function onSelectedIndexChangedEventHandler(ddlDOTINId, hfGCSId, e) {
            ...
            var savingMsg = EOSCRM.Web.Common.AjaxCRM.UpdateDotInPo(idArr[0], di, idArr[2], idArr[3]);
                        ...
                        <asp:TemplateField HeaderStyle-Width="65px" HeaderText="Mã đường phố">
                            <ItemTemplate>
                                ...
                                <asp:HiddenField id="hfGCS" runat="server" value='<%# 
                                        Eval("MADPPO") + DELIMITER.Delimiter + 
                        ...
                        <asp:TemplateField HeaderText="Đợt GCS" HeaderStyle-Width="100px">
                            <ItemTemplate>
                                <asp:DropDownList ID="ddlDOTIN" runat="server"
                                    DataSource='<%# new ReportClass().BienKHNuoc("", new DotInHDDao().Get(Eval("IDMADOTIN").ToString()).MAKVPO, "", "", 1, 1, "DSDOTINKVDD")  %>' 
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Mã Đ.Phố " HeaderStyle-Width="50px">
                            ...
                            <asp:LinkButton ID="lkbtMADPXBC" runat="server" CommandArgument='<%# Eval("IDMADP") %>'
                                CommandName="EditItem" CssClass="link" Text='<%# HttpUtility.HtmlEncode(Eval("MADPPO").ToString()) %>'></asp:LinkButton>
                            </ItemTemplate>
                            <ItemStyle Font-Bold="true" />
                        </asp:TemplateField>  
                        ...
                        <asp:TemplateField HeaderText="Đợt GCS cũ" HeaderStyle-Width="100px">
                            <ItemTemplate>
                                <asp:DropDownList ID="ddlDOTINCUXBC" runat="server" CssClass="readonly" ReadOnly="true"
                                    DataSource='<%# new ReportClass().BienKHNuoc("", new DotInHDDao().Get(Eval("IDMADOTINCU").ToString()).MAKVPO, "", "", 1, 1, "DSDOTINKVDD")  %>' 
