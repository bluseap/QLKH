<%@ Page Language="C#" MasterPageFile="~/Shared/EOS.Master" AutoEventWireup="true" 
    CodeBehind="rpPhieuCongTacSuaChua.aspx.cs" Inherits="EOSCRM.Web.Forms.KhachHang.BaoCao.DonLapDatMoi.rpPhieuCongTacSuaChua" %>
...
<asp:Content ID="content" ContentPlaceHolderID="ContentPlaceHolderMain" runat="server">
    ...
    <table class="crmtable">
        <tbody>
            ...
            <tr>
                <td class="crmcell right">Tồn</td>                
                <td class="crmcell" colspan="3">
                    <div class="left">
                        <asp:TextBox ID="txtTon" runat="server" Width="200px"  Text = "" />
                    </div>
                </td>
            </tr>
