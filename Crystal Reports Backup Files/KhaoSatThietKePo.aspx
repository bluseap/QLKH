<%@ Page Language="C#" MasterPageFile="~/Shared/PO.Master" AutoEventWireup="true" 
    CodeBehind="KhaoSatThietKePo.aspx.cs" Inherits="EOSCRM.Web.Forms.ThietKe.Power.KhaoSatThietKePo" %>
    ...
    <asp:UpdatePanel ID="upnlInfor" UpdateMode="Conditional" runat="server">
        <ContentTemplate>  
            ...
            <div class="crmcontainer p-5">
                <a href="/Forms/ThietKe/Power/NhapTKPower.aspx">Chuyển sang bước kế tiếp</a>
            </div>
        </ContentTemplate>
    </asp:UpdatePanel> 
</asp:Content>
