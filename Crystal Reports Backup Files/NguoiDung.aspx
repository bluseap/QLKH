        ...
        <ContentTemplate>
            <div class="crmcontainer">
                <table class="crmtable">
                    <tbody>
                        <tr>
                            <td class="crmcell right">Tên người dùng</td>
                            <td class="crmcell">
                                <div class="left">
                                    <asp:Label ID="lbTENNGUOIDUNG" runat="server" Font-Bold="True" ForeColor="#3366FF" ></asp:Label>
                                </div>
                                <div class="left">
            ...
            <div class="crmcontainer">
                <eoscrm:Grid 
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Tài khoản">
                            <ItemTemplate>
                                <asp:LinkButton ID="lnkBtnIDHOTEN" runat="server" 
                                    CommandArgument='<%# Eval("Id") %>' CommandName="EditUser"
                                    Text='<%# Eval("HoTen") %>'></asp:LinkButton>
                            </ItemTemplate>
