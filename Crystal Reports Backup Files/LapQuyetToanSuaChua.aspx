<%@ Page Language="C#" MasterPageFile="~/Shared/EOS.Master" AutoEventWireup="true"
    CodeBehind="LapQuyetToanSuaChua.aspx.cs" Inherits="EOSCRM.Web.Forms.SuaChua.LapQuyetToanSuaChua" %>
...
<asp:Content ID="head" ContentPlaceHolderID="headCPH" runat="server">
    <script type="text/javascript">
        ...
        function CheckFormAddVatTu() {
            ...
            __doPostBack('<%= CommonFunc.UniqueIDWithDollars(txtMAVT) %>', '');

            return false;
        }

        function CheckFormAddKhoiLuong() {
            openWaitingDialog();
            unblockWaitingDialog();

            __doPostBack('<%= CommonFunc.UniqueIDWithDollars(linkBtnAddVatTu) %>', '');

            return false;
        }

        function CheckFormAddKhoiLuongKeyPress(e) {
            var code = (e.keyCode ? e.keyCode : e.which);
            jQuery.fn.exists = function() { return jQuery(this).length > 0; }
            if (code == 13) {
                return CheckFormAddKhoiLuong();
            }
        }

        function CheckFormAddVatTu117() {
            openWaitingDialog();
            unblockWaitingDialog();

            __doPostBack('<%= CommonFunc.UniqueIDWithDollars(txtMAVT117) %>', '');

            return false;
        }

        function CheckFormAddKhoiLuong117() {
            openWaitingDialog();
            unblockWaitingDialog();

            __doPostBack('<%= CommonFunc.UniqueIDWithDollars(linkBtnAddVatTu117) %>', '');

            return false;
        }

        function CheckFormAddKhoiLuong117KeyPress(e) {
            var code = (e.keyCode ? e.keyCode : e.which);
            jQuery.fn.exists = function() { return jQuery(this).length > 0; }
            if (code == 13) {
                return CheckFormAddKhoiLuong117();
            }
        }
        ...
        function UpdateCTQTSC(maDDK, maVT, txtSLId, txtGIAVTId, lblTIENVT, txtGIANCId, lblTIENNC) {
            ...
            var msg = EOSCRM.Web.Common.AjaxCRM.UpdateCTQTSC(maDDK, maVT, sl, gvt, gnc);
            ...
            if (msg.value == "<%= DELIMITER.Passed %>") {
                document.getElementById(lblTIENVT).innerHTML = sl * gvt;
                document.getElementById(lblTIENNC).innerHTML = sl * gnc;
            }
        }

        function UpdateCTQTSC117(maDDK, maVT, txtSLId, txtGIAVTId, lblTIENVT, txtGIANCId, lblTIENNC) {
            var sl = document.getElementById(txtSLId).value;
            var gvt = document.getElementById(txtGIAVTId).value;
            var gnc = document.getElementById(txtGIANCId).value;

            var msg = EOSCRM.Web.Common.AjaxCRM.UpdateCTQTSC117(maDDK, maVT, sl, gvt, gnc);
        ...
        function updateGCCT(maGC, clientId) {
            ...
            var msg = EOSCRM.Web.Common.AjaxCRM.UpdateGCCTCSC(maGC, noidung);
        ...
        function updateCPCT(maCP, txtNDclientId, txtDGclientId, ddlDVTclientId, txtSLclientId,
            ...
            var msg = EOSCRM.Web.Common.AjaxCRM.UpdateCPCTSC(maCP, nd, dg, dvt, sl, hs, loai);
            ...
            if (msg.value == "<%= DELIMITER.Passed %>") {
                document.getElementById(lblTTclientId).innerHTML = sl * hs * dg;
            }
        }
        ...
        function updateCPCT117(maCP, txtNDclientId, txtDGclientId, ddlDVTclientId, txtSLclientId,
            ...
            var msg = EOSCRM.Web.Common.AjaxCRM.UpdateCPCTSCND117(maCP, nd, dg, dvt, sl, hs, loai);
...
<asp:Content ID="content" ContentPlaceHolderID="ContentPlaceHolderMain" runat="server">
    ...
    <div class="crmcontainer" id="divGridList" runat="server">
        <eoscrm:Grid ID="gvList" runat="server" UseCustomPager="true" OnRowDataBound="gvList_RowDataBound"
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="Địa chỉ Hạng Mục" HeaderStyle-Width="35%">
                    <ItemTemplate>
                ...
                <asp:TemplateField HeaderText="Hoạt động" HeaderStyle-Width="80px">
                    <ItemTemplate>
                        <asp:LinkButton ID="lnkBtnID2" runat="server" CommandArgument='<%# Eval("MADON") %>'
                            CommandName="EditItem" Text='Chạy Quyết Toán'></asp:LinkButton>
                    </ItemTemplate>
                </asp:TemplateField>
            </Columns>
        </eoscrm:Grid>
    ...
    <asp:UpdatePanel ID="upnlCustomers" UpdateMode="Conditional" runat="server">
        <ContentTemplate>
            ...
            <table class="crmcontainer">
		            ...
		            <td>
		                <table class="crmtable">
		                    <tr>
		                        ...
		                        <td class="crmcell">
		                            <div class="left">
		                                <asp:TextBox ID="txtMAVT" Width="60px" runat="server"
		                                    onchange="return CheckFormAddVatTu();"
		                                    OnTextChanged="txtMAVT_TextChanged"  />
		                            </div>
		                            <div class="left">
		                            ...
		                            <div class="left">
		                                <asp:TextBox ID="txtKHOILUONG" Width="60px" runat="server"
		                                    onkeypress="return CheckFormAddKhoiLuongKeyPress(event);" />
		                                <asp:LinkButton ID="linkBtnAddVatTu" CausesValidation="false" style="display:none"  
                                            OnClick="linkBtnAddVatTu_Click" runat="server">AddVATTU</asp:LinkButton>
		                            </div>
		                            <div class="left">
					                ...
					                <asp:TemplateField HeaderText="Hoạt động" HeaderStyle-Width="60px">
						                <ItemTemplate>
							                <asp:LinkButton ID="btnDelete" Text="Xóa" CommandName="DeleteGhiChu" 
							                    CausesValidation="false" CommandArgument='<%# Eval("MAGC")%>' runat="server"></asp:LinkButton>	
						                </ItemTemplate>
					                </asp:TemplateField>
				                </Columns>
			                </eoscrm:Grid>
		        ...
		        <tr style="display:none">
                    <td class="header">Chi phí đào lấp</td> 
		        </tr>
		        <tr style="display:none">
		            <td>
		                <table class="crmtable">
                                    ...
                                    <asp:TemplateField HeaderText="Loại chi phí" HeaderStyle-Width="70px">
                                        <ItemTemplate>
                                            <asp:DropDownList ID="ddlLOAICP" runat="server" SelectedValue='<%# Bind("LOAICP") %>'
                                                ...
                                                <asp:ListItem Value="LAP">Lấp</asp:ListItem>
		            ...
		            <td>
		                <table class="crmtable">
		                    <tr>
		                        ...
		                        <td class="crmcell">
		                            <div class="left">
		                                <asp:TextBox ID="txtMAVT117" runat="server" Width="60px"
		                                    onchange="return CheckFormAddVatTu117();"
		                                    OnTextChanged="txtMAVT117_TextChanged"  />
		                            </div>
		                            <div class="left">
		                            ...
		                            <div class="left">
		                                <asp:TextBox ID="txtKHOILUONG117" Width="60px" runat="server" 
		                                    onkeypress="return CheckFormAddKhoiLuong117KeyPress(event);" />
		                                <asp:LinkButton ID="linkBtnAddVatTu117" CausesValidation="false" style="display:none"  
                                            OnClick="linkBtnAddVatTu117_Click" runat="server">AddVATTU117</asp:LinkButton>
		                            </div>
		                            <div class="left">
		        ...
		        <%--<tr style="display:none">
                    <td class="header">Chi phí đào lấp theo nghị định 117</td> 
		        </tr>
		        <tr style="display:none">
		            <td>
		                <table class="crmtable">
                ...
                <table class="crmtable">
                    ...
                    <tr>
                        ...
                        <td class="crmcell" colspan="3">
                            <div class="left">
                                <%--<b>(MP)</b><asp:Button ID="btnBaoCaoMienPhi" CssClass="report" 
                                    UseSubmitBehavior="false" runat="server" onclick="btnBaoCaoMienPhi_Click" />
                                <b>(TT)</b><asp:Button ID="btnBaoCaoThanhToan" CssClass="report" runat="server" 
                                    UseSubmitBehavior="false" onclick="btnBaoCaoThanhToan_Click" />
                                <b>(Tổng hợp)</b>--%><asp:Button ID="btnBaoCao" CssClass="report" runat="server" UseSubmitBehavior="false"
	...
	<div class="crmcontainer p-5">
        <a href="DuyetChietTinhSuaChua.aspx">Chuyển sang bước kế tiếp</a>
    </div>
</asp:Content>
