<%@ Page Title="" Language="C#" MasterPageFile="~/Shared/PO.Master" AutoEventWireup="true" CodeBehind="NhapHopDongPo.aspx.cs" Inherits="EOSCRM.Web.Forms.ThietKe.Power.NhapHopDongPo" %>
...
<asp:Content ID="content" ContentPlaceHolderID="ContentPlaceHolderMain" runat="server">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="crmcell">
                                ...
                                <div class="left">
                                    <div class="right">Phường, xã</div>
                                </div>
                                <div class="left">
                        ...
                        <tr>
                            <td class="crmcell right">Cỡ đồng hồ điện</td>
                            <td class="crmcell">
                                <div class="left width-250">
                                ...
                                <div class="left">
                                    <div class="right">Loại dây nhánh</div>
                                </div>
                                <div class="left">
                    ...
                    <Columns>                    
                        ...
                        <asp:TemplateField HeaderText="Mã đơn" HeaderStyle-Width="75px">
                            ...
                            <asp:LinkButton ID="lnkBtnID" runat="server" CommandArgument='<%# Eval("MADDKPO") %>'
                                CommandName="EditItem" CssClass="link" Text='<%# HttpUtility.HtmlEncode(Eval("MADDKPO").ToString()) %>'></asp:LinkButton>
                            </ItemTemplate>
	...
	<div class="crmcontainer p-5">
        <a href="/Forms/ThiCongCongTrinh/Power/NhapThiCongPo.aspx">Chuyển sang bước kế tiếp</a>
    </div>
</asp:Content>
