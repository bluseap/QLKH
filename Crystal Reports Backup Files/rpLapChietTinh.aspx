<%@ Page Language="C#" MasterPageFile="~/Shared/EOS.Master" AutoEventWireup="true" 
    CodeBehind="rpLapChietTinh.aspx.cs" Inherits="EOSCRM.Web.Forms.KhachHang.BaoCao.DonLapDatMoi.rpLapChietTinh" %>
        ...
        <tbody>
            <tr>
                ...
                <td class="crmcell" style="width: 204px">
                    <div class="left">
                        <asp:TextBox ID="txtGiamDoc" runat="server" Width="200px" 
                            Text = "LƯƠNG VĂN BẠ" />
                    </div>
                </td>
            </tr>
