<%@ Page Language="C#" MasterPageFile="~/Shared/EOS.master" AutoEventWireup="True"
    Inherits="EOSCRM.Web.Forms.DanhMuc.LoaiKhachHangDb" CodeBehind="LoaiKhachHangDb.aspx.cs" %>
                ...
                <eoscrm:Grid ID="gvList" runat="server" UseCustomPager="true" OnRowDataBound="gvList_RowDataBound" 
                    ...
                    <Columns>
                       <asp:TemplateField HeaderStyle-CssClass="checkbox">
                            ...
                            <ItemTemplate>
                                <input id="Id" runat="server" type="hidden" value='<%# Eval("MALKHDB") %>' />
                                <input name="listIds" type="checkbox" value='<%# Eval("MALKHDB") %>' />
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Mã loại" HeaderStyle-Width="20%">
                            <ItemTemplate>
                                <asp:LinkButton ID="lnkBtnID" runat="server" CommandArgument='<%# Eval("MALKHDB") %>'
                                    CommandName="EditItem" Text='<%# Eval("MALKHDB") %>'></asp:LinkButton>
                            </ItemTemplate>
                            <ItemStyle Font-Bold="True" />
                        </asp:TemplateField>
                        <asp:BoundField HeaderStyle-Width="78%" DataField="TENLKHDB" HeaderText="Tên loại" />
                    </Columns>
                </eoscrm:Grid>        
            </div>
        </ContentTemplate>
