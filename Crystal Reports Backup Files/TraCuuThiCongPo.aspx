<%@ Page Title="" Language="C#" MasterPageFile="~/Shared/PO.Master" AutoEventWireup="true" CodeBehind="TraCuuThiCongPo.aspx.cs" Inherits="EOSCRM.Web.Forms.ThiCongCongTrinh.Power.TraCuuThiCongPo" %>
            ...
            <div class="crmcontainer">
                <table class="crmtable">
                    <tbody>
                        ...
                        <tr>
                            <td class="crmcell right">
                                <asp:Label ID="lbLyDoTC" runat="server" Text="Lý do" Font-Bold="True" Font-Size="Large" ForeColor="Red"></asp:Label>
                            </td>
                            <td class="crmcell">
                                <div class="left">
