<%@ Page Title="" Language="C#" MasterPageFile="~/Shared/EOS.Master" AutoEventWireup="true" CodeBehind="DieuChinhHoaDon.aspx.cs" Inherits="EOSCRM.Web.Forms.GhiChiSo.DieuChinhHoaDon" %>
                ...
                <table class="crmtable">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="crmcell">
                                <div class="left width-100">
                                    <asp:TextBox ID="txtMASOHD" runat="server" Width="120px" MaxLength="20" TabIndex="6" OnTextChanged="txtMASOHD_TextChanged" />
                                </div>
                                <div class="left">
                        ...
                        <tr>
                            <td class="crmcell right">Tính 1 giá MĐSD</td>
                            <td class="crmcell">
                                <div class="left">                                    
                        ...
                        <tr>
                            ...
                            <td class="crmcell">
                                <div class="left width-100">
                                    <asp:TextBox ID="txtCSMOI" runat="server" Width="50px" MaxLength="10" TabIndex="7" />
                                </div>
                                <div class="left">
                                    <div class="right">CS Cũ</div>
                                </div>
                                <div class="left width-100">
                                    <asp:TextBox ID="txtCSCU" runat="server" Width="50px" MaxLength="10" TabIndex="8" />
                                </div>       
                                <div class="left">
        ...
        <ContentTemplate>
            <div class="crmcontainer">
                <eoscrm:Grid ID="gvDieuChinhHD" runat="server" UseCustomPager="True" PageSize="20"
                    OnRowCommand="gvDieuChinhHD_RowCommand" OnPageIndexChanging="gvDieuChinhHD_PageIndexChanging" PagerInforText="">
                    ...
                    <Columns>
                        ...
                        <asp:BoundField HeaderStyle-Width="30%" HeaderText="Mã số HÐ" DataField="MASOHDDC" >                        
                            <HeaderStyle Width="30%" />
                        </asp:BoundField>
                        <asp:BoundField HeaderStyle-Width="30%" HeaderText="CS mới ÐC" DataField="CHISOCUOIDC" >                        
                            <HeaderStyle Width="10%" />
                        </asp:BoundField>
                        <asp:BoundField HeaderStyle-Width="30%" HeaderText="CS cũ ÐC" DataField="CHISODAUDC" >                        
                            <HeaderStyle Width="10%" />
                        </asp:BoundField>
                        <asp:BoundField HeaderStyle-Width="30%" HeaderText="Tr.Thu" DataField="MTRUYTHUDC" >                        
                            <HeaderStyle Width="10%" />
                        </asp:BoundField>
                        <asp:BoundField HeaderStyle-Width="30%" HeaderText="Tiêu thụ" DataField="KLTIEUTHUDC" >                        
                            <HeaderStyle Width="10%" />
                        </asp:BoundField>
                        <asp:BoundField HeaderStyle-Width="30%" HeaderText="Tổng tiền" 
                            DataField="TONGTIENDC" DataFormatString="{0:#.####}" >                        
                            <HeaderStyle Width="30%" />
                        </asp:BoundField>   
                        <asp:BoundField HeaderStyle-Width="30%" HeaderText="In BK ĐC" DataField="INHDDC" >                        
                            <HeaderStyle Width="10%" />
                        </asp:BoundField>                 
                    </Columns>                    
                </eoscrm:Grid> 
