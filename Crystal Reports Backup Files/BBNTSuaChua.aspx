<%@ Page Title="" Language="C#" MasterPageFile="~/Shared/EOS.Master" AutoEventWireup="true" CodeBehind="BBNTSuaChua.aspx.cs" Inherits="EOSCRM.Web.Forms.ThiCongCongTrinh.BBNTSuaChua" %>
							        ...
							        <eoscrm:Grid ID="gvDDK" runat="server" UseCustomPager="true" 
                                        ...
                                        <Columns>
                                            <asp:TemplateField HeaderStyle-Width="10%" HeaderText="Mã đơn">
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="lnkBtnID" runat="server" 
                                                        CommandArgument='<%# Eval("MADON") %>' CommandName="EditItem"                                                         
                                                        Text='<%# Eval("KHACHHANG.MADP").ToString() + Eval("KHACHHANG.MADB").ToString() %>'>
            ...
            <div class="crmcontainer">
                <eoscrm:Grid ID="gvBienBan" runat="server" UseCustomPager="true" OnRowDataBound="gvBienBan_RowDataBound" 
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Tên KH" HeaderStyle-Width="35%">
                            <ItemTemplate>
                                <%# Eval("GIAIQUYETTHONGTINSUACHUA.KHACHHANG.TENKH")  %> 
                            </ItemTemplate>
                        </asp:TemplateField>
