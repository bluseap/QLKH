<%@ Page Title="" Language="C#" MasterPageFile="~/Shared/PO.Master" AutoEventWireup="true" CodeBehind="DSChuaHopDongPo.aspx.cs" Inherits="EOSCRM.Web.Forms.ThietKe.Power.BaoCaoPo.DSChuaHopDongPo" %>
        ...
        <table class="crmtable">
            <tbody>
                ...
                <tr>
                    ...
                    <td class="crmcell">    
                        <div class="left">
                            <asp:Button ID="btnBaoCao" OnClientClick="return CheckFormReport();" runat="server" onclick="btnBaoCao_Click" CssClass="myButton" Text="Chưa lập hợp đồng điện"/>
                        </div>
                        <td class="crmcell right"></td>
                        <td class="crmcell">    
                            <div class="left">
                                <asp:Button ID="btDaLapHD" OnClientClick="return CheckFormbtDaLapHD();" runat="server" CssClass="myButton" Text="Đã lập hợp đồng điện" OnClick="btDaLapHD_Click" />
                            </div>
                        </td>
                    </td>
                </tr>
