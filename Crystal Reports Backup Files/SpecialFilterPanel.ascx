...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SpecialFilterPanel.ascx.cs"
    Inherits="EOSCRM.Web.UserControls.SpecialFilterPanel" %>
            ...
            <tr>
                ...
                <td class="crmcell">
                    <div class="left width-200">
                        <asp:TextBox ID="txtMADDK" onkeypress="return CheckKeywordFilter(event);" runat="server" Width="150px" MaxLength="200" />
                    </div>
                    <div class="left width-150">
                        <div class="right">Tên khách hàng</div>
                    </div>
                    <div class="left">
                        <asp:TextBox ID="txtTENKH" onkeypress="return CheckKeywordFilter(event);" runat="server" Width="150px" MaxLength="200" />
                    </div>
                </td>
            </tr>
            <tr>
                ...
                <td class="crmcell">
                    <div class="left width-200">
                        <asp:TextBox ID="txtDIACHILD" onkeypress="return CheckKeywordFilter(event);" runat="server" Width="150px" MaxLength="200" />
                    </div>
                    <div class="left width-150">
                        <div class="right">Số điện thoại</div>
                    </div>
                    <div class="left">
                        <asp:TextBox ID="txtDIENTHOAI" onkeypress="return CheckKeywordFilter(event);" runat="server" Width="100px" MaxLength="200" />
                    </div>
                </td>
            </tr>
            <tr>
                ...
                <td class="crmcell">
                    ...
                    <div class="left width-150">
                        <div class="right">Ngày đăng ký</div>
                    </div>
                    <div class="left">
