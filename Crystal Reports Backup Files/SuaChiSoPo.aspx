<%@ Page Title="" Language="C#" MasterPageFile="~/Shared/PO.Master" AutoEventWireup="true" CodeBehind="SuaChiSoPo.aspx.cs" Inherits="EOSCRM.Web.Forms.GhiChiSo.Power.SuaChiSoPo" %>
        ...
        function onKeyDownEventHandler(txtCHISODAUId, txtCHISOCUOIId, txtMTRUYTHUId, txtKLTIEUTHUId, ddlTTHAIGHIId, hfGCSId, order, e) {
            ...
            if (code == 13) {
                if (order == 1)
                    ...
                    var savingMsg = EOSCRM.Web.Common.AjaxCRM.UpdateGCS2Po(idArr[0], idArr[1], idArr[2], csd, csc, mtt, kltt, idArr[8], tthaighi, idArr[7]);
                                                ...
                                                <asp:TemplateField HeaderStyle-Width="10%" HeaderText="Mã KH">
                                                    <ItemTemplate>
                                                        <asp:LinkButton ID="lnkBtnID" runat="server" CommandName="SelectSODB" 
                                                            CommandArgument='<%# Eval("MADPPO") + Eval("DUONGPHUPO").ToString() + Eval("MADBPO") %>'
