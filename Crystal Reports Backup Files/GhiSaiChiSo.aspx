...
<%@ Page Language="C#" MasterPageFile="~/Shared/EOS.Master" AutoEventWireup="true" 
    CodeBehind="GhiSaiChiSo.aspx.cs" Inherits="EOSCRM.Web.Forms.TruyThu.GhiSaiChiSo" %>
...
<asp:Content ID="head" ContentPlaceHolderID="headCPH" runat="server">
    <script type="text/javascript">
        ...
        function onKeyDownEventHandler(txtCHISODAUId, txtCHISOCUOIId, txtKLTIEUTHUId, hfGCSId, order, e) {
            // get key code
            if (!isValid)
                return;
            ...
            if (code == 13) {
                    ...
                    //FocusAndSelect(txtKLTIEUTHUId);
                {
                    ...
                    var savingMsg = EOSCRM.Web.Common.AjaxCRM.UpdateGCS(idArr[0], idArr[1], idArr[2], csd, csc, kltt, idArr[7], tthaighi, idArr[6]);
