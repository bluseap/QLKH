<%@ Page Language="C#" MasterPageFile="~/Shared/EOS.master" AutoEventWireup="True"
    Inherits="EOSCRM.Web.Forms.DanhMuc.ThongTinXuLy" CodeBehind="ThongTinXuLy.aspx.cs" %>
        ...
        <ContentTemplate>
            <div class="crmcontainer">
                <table class="crmtable">
                    <tbody>
                        <tr>    
                            <td class="crmcell right">Mã xử lý</td>
                            <td class="crmcell"> 
                                <div class="left">
                                    <asp:TextBox ID="txtMAXL" runat="server" Width="100px" MaxLength="10" TabIndex="1" />
                                </div>
                                <div class="left width-150">
                                    <div class="right">Tên xử lý</div>
                                </div>
                                <div class="left">
                                    <asp:TextBox ID="txtTENXL" runat="server" Width="250px" MaxLength="50" TabIndex="2" />
                                </div>
                            </td>
                        </tr>
                        <tr>    
                            ...
                            <td class="crmcell"> 
                                <div class="left">
                                    <asp:TextBox ID="txtSTT" runat="server" Width="100px" MaxLength="10" TabIndex="3" />
                                </div>
                                <div class="left width-150">                                    
                                </div>
                                <div class="left">
                                    <asp:CheckBox ID="cbActive" runat="server" TabIndex="4" />
                                </div>
                                <div class="left">
                                    <strong>Có hiển thị</strong>
                                </div>
                                <div class="left">
                                    <asp:CheckBox ID="cbISLAPCHIETTINH" runat="server" TabIndex="5" />
                                </div>
                                <div class="left">
                                    <strong>Có lập chiết tính</strong>
                                </div>
                            </td>
                        </tr>
                        <tr>    
        ...
        <ContentTemplate>
            <div class="crmcontainer">
                <eoscrm:Grid ID="gvList" runat="server" UseCustomPager="true" OnRowDataBound="gvList_RowDataBound" 
                    ...
                    <PagerSettings FirstPageText="thông tin xử lý" PageButtonCount="2" />
                    <Columns>
                       <asp:TemplateField HeaderStyle-CssClass="checkbox">
                            ...
                            <ItemTemplate>
                                <input id="Id" runat="server" type="hidden" value='<%# Eval("MAXL") %>' />
                                <input name="listIds" type="checkbox" value='<%# Eval("MAXL") %>' />
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Mã XL" HeaderStyle-Width="20%">
                            <ItemTemplate>
                                <asp:LinkButton ID="lnkBtnID" runat="server" CommandArgument='<%# Eval("MAXL") %>'
                                    CommandName="EditItem" Text='<%# Eval("MAXL") %>'></asp:LinkButton>
                            </ItemTemplate>
                            <ItemStyle Font-Bold="True" />
                        </asp:TemplateField>
                        <asp:BoundField HeaderStyle-Width="78%" DataField="TENXL" HeaderText="Tên XL" />
                    </Columns>
                </eoscrm:Grid>        
            </div>
        </ContentTemplate>
