<%@ Page Title="" Language="C#" MasterPageFile="~/Shared/PO.Master" AutoEventWireup="true" CodeBehind="TraCuuHopDongPo.aspx.cs" Inherits="EOSCRM.Web.Forms.ThietKe.Power.TraCuuHopDongPo" %>
...
<%@ Register Src="/UserControls/HopDongFilterPanel.ascx" TagName="HopDongFilterPanel"
    TagPrefix="bwaco" %>
...
<asp:Content ID="content" ContentPlaceHolderID="ContentPlaceHolderMain" runat="server">
	...
	<bwaco:HopDongFilterPanel ID="filterPanel" runat="server" />
	
	<asp:UpdatePanel ID="upnlInfor" UpdateMode="Conditional" runat="server">
		<ContentTemplate>
		    <br />
            <div class="crmcontainer" id="divInfor" runat="server" visible="false">
                <table class="crmtable">
                    <tbody>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td class="crmcell">
                                <div class="left">
                                    <asp:TextBox ID="txtDANHSOHD" runat="server" MaxLength="10" Width="80px" 
                                        TabIndex="7" />
                                </div>
                                <div class="left">
                                ...
                                <div class="left">
                                    <asp:Label ID="lblTENDUONG" runat="server" Visible ="false"/>
                                </div>
                            </td>          
                        </tr> 
                        <tr>
            ...
            <div class="crmcontainer">
                <eoscrm:Grid 
                    ...
                    <Columns>                    
                        ...
                        <asp:TemplateField HeaderText="Trạng thái" HeaderStyle-Width="75px">
                            <ItemTemplate>
                                <%# (Eval("DACAPDB") != null && Convert.ToBoolean(Eval("DACAPDB"))) ?
                                        "Đã cấp danh bộ" : "" %>
                            </ItemTemplate>
                        </asp:TemplateField>
                    </Columns>
